...
O ritmo circadiano é o pilar **R** do Método AGIR (Avaliar · Gerir · Integrar · Reavaliar), e talvez o mais negligenciado em medicina convencional. No painel inicial do Continuum, registramos cronotipo (Munich ChronoType Questionnaire), padrão de exposição à luz, qualidade subjetiva de sono (PSQI), e quando há indicação, oxigração noturna domiciliar e estudo de cortisol salivar diurno.
