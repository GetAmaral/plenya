...
![Duas curvas de cortisol desenhadas a mão em um caderno: à esquerda o pico matinal saudável seguido de descida; à direita, uma reta quase plana — a assinatura do eixo HPA exausto.](/images/blog/burnout-nao-e-cansaco-resposta-neuroendocrina/cortisol-curve-flat.webp)
...
![Pequeno tubo de laboratório com gota âmbar ao lado de um relógio de bolso marcando o início da manhã — o cortisol salivar matinal é o exame que conta a história do eixo HPA.](/images/blog/burnout-nao-e-cansaco-resposta-neuroendocrina/inline.webp)
