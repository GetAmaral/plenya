...
O tratamento, na nossa abordagem integrativa, tem quatro camadas que precisam acontecer ao mesmo tempo, exatamente as quatro frentes do método AGIR (Atividade Física, Alimentação e Suplementação Inteligente · Gestão Clínica e Metabólica · Integração Mente-Corpo · Ritmo Circadiano e Repouso):
