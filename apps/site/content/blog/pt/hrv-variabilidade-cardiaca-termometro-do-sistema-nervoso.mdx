...
![Traçado de batimentos sobre papel quadriculado, com intervalos visivelmente desiguais entre os picos — a variação saudável que o HRV mede.](/images/blog/hrv-variabilidade-cardiaca-termometro-do-sistema-nervoso/heartbeat-intervals.webp)
...
![Um relógio de pulso analógico simples sobre uma mesa de madeira escura, com um pequeno espelho refletindo apenas luz suave — o ato de medir o tempo entre batimentos como gesto de auto-observação, composição editorial.](/images/blog/hrv-variabilidade-cardiaca-termometro-do-sistema-nervoso/inline.webp)
