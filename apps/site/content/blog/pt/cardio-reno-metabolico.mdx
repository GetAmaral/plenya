...
Por isso a leitura nefrológica, quando treinada para olhar para a janela silenciosa, vê antes. O exame mais frequentemente pedido — função renal — é, paradoxalmente, um dos melhores marcadores precoces de doença sistêmica. É essa lógica que orienta o método AGIR (Avaliar · Gerir · Integrar · Reavaliar) na primeira leitura de cada Continuum.
