...
![Tabela de leitura do escore de cálcio coronariano (CAC, Agatston): 0 = sem placa detectável (risco <2% em 10 anos, repetir em 5 anos); 1-99 = placa leve (risco 5-7%, considerar estatina); 100-399 = placa moderada (risco 12-15%, estatina + alvo ApoB <80); ≥400 = placa avançada (risco >20%, estatina alta potência + ApoB <65 + cardiologia preventiva).](/images/blog/escore-de-calcio-coronariano-r800-que-muda-uma-decada/figura-1.webp)
