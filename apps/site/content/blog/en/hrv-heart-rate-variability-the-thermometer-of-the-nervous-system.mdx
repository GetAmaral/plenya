...
![Comparison of R-R interval traces. Above, high HRV (rMSSD ~65 ms) with visible variation between consecutive beats — active parasympathetic system, adequate recovery. Below, low HRV (rMSSD ~22 ms) with almost metronomic intervals — chronic sympathetic predominance, the pattern of burnout, overtraining, or subclinical disease.](/images/blog/hrv-variabilidade-cardiaca-termometro-do-sistema-nervoso/figura-1.webp)
