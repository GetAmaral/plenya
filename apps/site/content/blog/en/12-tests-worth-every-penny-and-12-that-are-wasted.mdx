...
excerpt: "A R$ 4,000 checkup package that forgot ApoB and measured three tumor markers with no indication. It is not the exception. It is the rule of the market. Here is what to order and what to cut."
date: 2026-04-26
...
Patrícia arrived with a folder. Inside it, the result of the checkup she had paid R$ 4,200 for at a well-known lab chain. Fifty-two lines. Tumor marker CA 125 — without any gynecologic indication for ordering it. CA 19-9 — same thing. Anti-thyroglobulin, anti-TPO, reverse T3 — all without clinical justification. Five blood-cell counts duplicated in different formats.
...
**12. Coronary artery calcium score (CAC).** Not a blood test, but it belongs on this list. Non-contrast CT, low radiation dose, R$ 600–1,000 (about US$ 120–200). Measures calcified atherosclerotic plaque in the coronaries. In men &gt;40 and women &gt;50 with intermediate risk, or earlier if there is an early family history, it is the test that most reorganizes the preventive conversation. Done once; repeat in 5 years if zero, depending on management.
...
In Continuum Plenya, the initial panel is not a catalog. It is built for the patient — age, sex, family history, chief complaint, risk factors. Annual and semi-annual tests enter the score that evolves over time. The decision to order ApoB, Lp(a), CAC, or a complete hormone panel is born of clinical reading, not of a pre-closed R$ 4,000 package that came off the lab counter.
...
Patrícia's folder was reorganized. Six of the previous fifty-two tests remained. Seven new ones were ordered, targeted. The cost was R$ 1,300. And for the first time, she had a conversation in which every line of the report meant something.
