...
When the value is elevated, the action is not "wait for specific therapy." Through the AGIR method we apply, the action is **knock down every other modifiable risk factor more aggressively**:
