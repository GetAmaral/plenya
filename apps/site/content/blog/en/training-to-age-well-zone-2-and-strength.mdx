...
Before the recipe, a question: does the patient know they need it? If they still believe the current training works, the right place to start is [Training a lot and aging wrong](/en/blog/training-a-lot-and-aging-wrong), which describes the markers that betray off-target training. Here the work is prescriptive. Diagnosis first; recipe now.

We see cases in our practice like Felipe's: 46, a lawyer, runs 8 km five times a week and has done so for fifteen years. Same route, same pace, *comfortable running pace*, he says. Heart rate during the run: 158 to 172 bpm. For his age, that is Zone 3-4, the limbo of "comfortably uncomfortable." His diet is good, weight is stable, labs are "normal."

Our team asked for a cardiopulmonary exercise test (CPET) with lactate and body composition. The numbers confirmed what was suspected from his account: VO₂ max low for his age, lactate threshold crossed in almost every run, lean mass in the low band, grip strength below expected. *Doctor, I train more than anyone I know. Why are my numbers worse?*

Felipe is the common case in our practice. He trains a lot. He trains what matters little. Volume without direction is physiologic noise. And it charges a price. The recipe is specific.
...
Zone 2 is the aerobic intensity at which your mitochondria are working near the maximum capacity for fat oxidation, before the point at which lactate begins to accumulate above baseline. In practical terms: the patient can hold a conversation in complete sentences, with some respiratory effort, but without needing to pause for breath between words.
...
The other 20% of aerobic volume needs to be truly intense: short intervals (30 seconds to 4 minutes) at intensity the patient cannot sustain longer than that interval, with active rest. The target is **VO₂ max**.
...
Our team does not require a cardiopulmonary test to start, but some practical signals help:
...
In a more complete panel: CPET with gases for VO₂ max and lactate threshold, DEXA for body composition, dynamometer for grip. They are the panel that gives training real numbers. The same panel, read in the opposite direction, is what shows up in [Training a lot and aging wrong](/en/blog/training-a-lot-and-aging-wrong) as the signal that the current stimulus is off target.

## The reading the Continuum brings

Through the ACTS Method (Activity and Smart Nutrition · Clinical and Metabolic Management · Tending Mind-Body · Sleep and Circadian Rhythm) we apply at the Plenya Continuum, the exercise physiologist is not a "personal trainer": they enter the initial panel alongside the physician and the nutritionist, with access to labs, body composition, and the score. The plan is designed in three bands (Zone 2, intense, strength), with written progression and quarterly reassessment. Felipe, from the beginning, today runs less: three sessions a week, two in Zone 2 controlled by a heart rate monitor and one with intervals. Added three strength sessions. In eight months, VO₂ max climbed from 38 to 47, gained 3.2 kg (7 lbs) of lean mass, grip strength rose to 44 kg. *I train less. I'm a different runner.*
