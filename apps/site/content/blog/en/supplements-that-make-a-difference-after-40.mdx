...
**Practical indication:** 3–5 g/day of creatine monohydrate (not exotic forms — micronized or standard monohydrate). Taken consistently, every day, with or without training. Monthly cost: R$ 30 to 60 (about US$ 6–12).
...
![Dose protocol for the 4 supplements with strong evidence: creatine monohydrate 3–5 g/day (R$ 30–60/month, follow-up: annual kidney function); omega-3 EPA+DHA 1–2 g/day if index &lt;8% — or 4 g pure EPA in REDUCE-IT (R$ 80–150, target index &gt;8%); vitamin D3 2,000–5,000 IU adjusted by lab (R$ 20, target 25-OH 40–60 ng/mL); magnesium glycinate 200–400 mg/night (R$ 50). Typical total cost: R$ 180–280/month (about US$ 35–55) — vs. R$ 800–1,500 of the average patient with the pharmacy bag.](/images/blog/suplementos-que-fazem-diferenca-depois-dos-40/figura-2.webp)

## The reading the Continuum makes

Continuum Plenya does not sell supplements, has no store counter, has no affiliation. The supplementation list is designed based on specific labs — Omega-3 Index, 25-OH-vitamin D, magnesium (serum and sometimes intracellular), ferritin, B12, homocysteine. The recommendation is nominal: the substance, the dose, the trustworthy brand, the reassessment interval. Roberto, from the beginning, today takes four things. Spends R$ 180 per month. *For the first time, I know why for each one.*
