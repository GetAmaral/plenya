...
excerpt: "The lab clears it as normal starting at 15 ng/mL. But our team observes, in patients we follow longitudinally, that menstruating women with ferritin below 50 already live with real symptoms — fatigue, hair loss, dropping performance — without ever having become anemic."
date: 2026-04-26
...
She had done a CBC. Hemoglobin 13.1 g/dL — within range. Ferritin 38 ng/mL — the lab stamped it *reference value: 13 to 150*. *All normal*, she had heard from two different physicians. *It's the routine, it's stress, it's motherhood.*

It was none of those — as our team's panel made clear from the first reading.
...
The recent literature has worked to quantify this, and our team uses it as the floor of the conversation.
...
For an adult menstruating woman, or for any symptomatic adult, the useful clinical reading of ferritin our team applies is not the one on the label:
...
A technical caveat is worth noting: ferritin is an acute-phase protein. In any inflammatory state — infection, autoimmune disease, obesity, last week's flu — it rises falsely. If the patient has ferritin 70 but elevated hs-CRP, deficiency may be masked. The team always reads ferritin alongside complete CBC, transferrin saturation, total iron-binding capacity, and CRP.

## How to replace (and what not to do)

Oral replacement is the first line. Classical ferrous sulfate (40 to 65 mg elemental iron) works, but has a high rate of gastrointestinal intolerance — nausea, constipation, metallic taste. Patients who gave up on iron usually gave up because of that, not for lack of need.

Practical alternatives our team uses:
...
Initial ferritin 38, transferrin saturation 14%, hemoglobin 13.1, hs-CRP 0.4 (no inflammation). The team started iron bisglycinate 50 mg every other day, fasting, with vitamin C. Referral to gynecology to assess menorrhagia (which ended up indicating a hormonal IUD, which reduced flow to almost nothing).
