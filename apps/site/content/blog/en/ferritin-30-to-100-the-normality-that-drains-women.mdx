...
![Serum ferritin ruler from 0 to 200 ng/mL, divided into four zones: 0–15 (frank anemia), 15–50 (lab "normal" range, but symptomatic — fatigue, hair loss, drop in performance), 50–100 (OPTIMAL range, therapeutic target in menstruating women and athletes), 100–200 (high range — investigate inflammation or hemochromatosis). Ferritin falls before hemoglobin; treatment is to replace iron up to the optimal range, not to wait for anemia.](/images/blog/ferritina-30-a-100-normalidade-que-esgota-mulheres/figura-1.webp)
