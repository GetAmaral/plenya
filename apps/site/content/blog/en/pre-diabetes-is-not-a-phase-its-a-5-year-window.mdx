...
![Result of the Diabetes Prevention Program (DPP, NEJM 2002): in 3 years, 14% of the intensive intervention group (7% weight loss, 150 min/week of activity) progressed to diabetes, vs. 22% in the metformin group and 34% in placebo. Risk reduction of 58% with intervention, 31% with metformin. The window of maximum reversibility is 3–5 years from diagnosis.](/images/blog/pre-diabetes-nao-e-fase-e-janela-de-5-anos/figura-1.webp)
