...
![Comparative table between Medicine 2.0 (alarm — asks “what is the diagnosis?“, works with symptoms and abnormal labs, acts on established disease) and Medicine 3.0 (detector — asks “am I on the path?“, works with ApoB, hs-CRP, VO₂ max, fasting insulin, grip strength, homocysteine, acts within the silent window). Adapted from Attia P, Outlive 2023.](/images/blog/medicina-2-vs-3/figura-1.webp)
