...
-- 2. Registrar no histórico de revisão
INSERT INTO score_item_review_history (
    ...
    jsonb_build_object(
        ...
        'revision_method', 'manual_sql_update',
        'revision_date', NOW()
    ),
...
-- ================================================================
-- PRÓXIMA ETAPA: Buscar artigos científicos
-- Usar RAG para encontrar artigos similares no banco
-- Se <7 artigos: buscar no PubMed
-- ================================================================
