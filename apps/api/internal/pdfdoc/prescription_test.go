...
func TestRenderPrescription(t *testing.T) {
	...
	in := Prescription{
		...
		Meds: []Med{
			{Name: "Losartana potássica", Concentration: "50 mg", ActiveIngredient: "Losartana potássica",
				Posology: "1 comprimido · de 12/12h · via oral · por 30 dias",
				Quantity: "Quantidade: 60 (sessenta) comprimidos"},
			{Name: "Rosuvastatina cálcica", Concentration: "10 mg", ActiveIngredient: "Rosuvastatina cálcica",
				Posology: "1 comprimido · 1x ao dia (noite) · via oral · por 30 dias",
				Quantity: "Quantidade: 30 (trinta) comprimidos",
	...
	ctrl.Meds = []Med{{Name: "Clonazepam", Concentration: "2 mg", Posology: "1 comprimido · ao deitar · via oral · por 30 dias", Quantity: "Quantidade: 30 (trinta) comprimidos"}}
