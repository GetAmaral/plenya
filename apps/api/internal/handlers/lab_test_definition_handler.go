...
// ============================================================
// LabTestReferenceRange Endpoints
// ============================================================

// CreateLabTestReferenceRange creates a new reference range
// @Summary Create lab test reference range
// @Tags LabTests
// @Accept json
// @Produce json
// @Param range body models.LabTestReferenceRange true "Reference range data"
// @Success 201 {object} models.LabTestReferenceRange
// @Failure 400 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /api/v1/lab-tests/reference-ranges [post]
func (h *LabTestDefinitionHandler) CreateLabTestReferenceRange(c *fiber.Ctx) error {
	var refRange models.LabTestReferenceRange
	if err := c.BodyParser(&refRange); err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(ErrorResponse{
			Error: "Invalid request body",
		})
	}

	if err := h.service.CreateLabTestReferenceRange(&refRange); err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(ErrorResponse{
			Error: err.Error(),
		})
	}

	return c.Status(fiber.StatusCreated).JSON(refRange)
}

// GetLabTestReferenceRangeByID retrieves a reference range by ID
// @Summary Get lab test reference range by ID
// @Tags LabTests
// @Produce json
// @Param id path string true "Reference range ID"
// @Success 200 {object} models.LabTestReferenceRange
// @Failure 400 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
// @Router /api/v1/lab-tests/reference-ranges/{id} [get]
func (h *LabTestDefinitionHandler) GetLabTestReferenceRangeByID(c *fiber.Ctx) error {
	id, err := uuid.Parse(c.Params("id"))
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(ErrorResponse{
			Error: "Invalid ID format",
	...
	refRange, err := h.service.GetLabTestReferenceRangeByID(id)
	if err != nil {
		return c.Status(fiber.StatusNotFound).JSON(ErrorResponse{
			Error: err.Error(),
		})
	...
	return c.JSON(refRange)
}

// GetReferenceRangesForLabTest retrieves all reference ranges for a lab test
// @Summary Get reference ranges for lab test
// @Tags LabTests
// @Produce json
// @Param id path string true "Lab test ID"
// @Success 200 {array} models.LabTestReferenceRange
// @Failure 400 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /api/v1/lab-tests/definitions/{id}/reference-ranges [get]
func (h *LabTestDefinitionHandler) GetReferenceRangesForLabTest(c *fiber.Ctx) error {
	id, err := uuid.Parse(c.Params("id"))
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(ErrorResponse{
			Error: "Invalid ID format",
	...
	refRanges, err := h.service.GetReferenceRangesForLabTest(id)
	if err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(ErrorResponse{
			Error: err.Error(),
		})
	...
	return c.JSON(refRanges)
}

// UpdateLabTestReferenceRange updates a reference range
// @Summary Update lab test reference range
// @Tags LabTests
// @Accept json
// @Produce json
// @Param id path string true "Reference range ID"
// @Param range body models.LabTestReferenceRange true "Updated reference range data"
// @Success 200 {object} models.LabTestReferenceRange
// @Failure 400 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
// @Router /api/v1/lab-tests/reference-ranges/{id} [put]
func (h *LabTestDefinitionHandler) UpdateLabTestReferenceRange(c *fiber.Ctx) error {
	id, err := uuid.Parse(c.Params("id"))
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(ErrorResponse{
			Error: "Invalid ID format",
	...
	if err := h.service.UpdateLabTestReferenceRange(id, &refRange); err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(ErrorResponse{
			Error: err.Error(),
		})
	}

	updated, _ := h.service.GetLabTestReferenceRangeByID(id)
	return c.JSON(updated)
}

// DeleteLabTestReferenceRange soft deletes a reference range
// @Summary Delete lab test reference range
// @Tags LabTests
// @Param id path string true "Reference range ID"
// @Success 204
// @Failure 400 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
// @Router /api/v1/lab-tests/reference-ranges/{id} [delete]
func (h *LabTestDefinitionHandler) DeleteLabTestReferenceRange(c *fiber.Ctx) error {
	id, err := uuid.Parse(c.Params("id"))
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(ErrorResponse{
			Error: "Invalid ID format",
	...
	if err := h.service.DeleteLabTestReferenceRange(id); err != nil {
		return c.Status(fiber.StatusNotFound).JSON(ErrorResponse{
			Error: err.Error(),
		})
	}
