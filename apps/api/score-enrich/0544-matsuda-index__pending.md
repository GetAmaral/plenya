# ScoreItem: MATSUDA INDEX

**ID:** `c77cedd3-2800-79b7-8d46-6177393b972a`
**FullName:** MATSUDA INDEX (Exames - Laboratoriais)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-79b7-8d46-6177393b972a`.**

```json
{
  "score_item_id": "c77cedd3-2800-79b7-8d46-6177393b972a",
...
**ScoreItem:** MATSUDA INDEX (Exames - Laboratoriais)

**30 chunks de 11 artigos (avg similarity: 0.622)**
...
**Article:** Resistência Insulínica (2024)
**Journal:** Pos Graduacao MFI
**Section:** introduction | **Similarity:** 0.618
