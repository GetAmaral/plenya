# ScoreItem: Situação financeira, renda ativa e passiva

**ID:** `c77cedd3-2800-7ef7-880b-1faef5982a55`
**FullName:** Situação financeira, renda ativa e passiva (Social - Histórico)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7ef7-880b-1faef5982a55`.**

```json
{
  "score_item_id": "c77cedd3-2800-7ef7-880b-1faef5982a55",
...
**ScoreItem:** Situação financeira, renda ativa e passiva (Social - Histórico)

**30 chunks de 17 artigos (avg similarity: 0.588)**
...
### Chunk 30/30
**Article:** Progesterone and preterm birth (2020)
