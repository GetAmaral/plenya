# ScoreItem: EPHX1 rs1051740 Tyr113His (Detoxificação)

**ID:** `019c1a2b-a36f-7570-9fb8-fe4da0bd7b6f`
**FullName:** EPHX1 rs1051740 Tyr113His (Detoxificação) (Genética - Detoxificação)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7570-9fb8-fe4da0bd7b6f`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7570-9fb8-fe4da0bd7b6f",
...
**ScoreItem:** EPHX1 rs1051740 Tyr113His (Detoxificação) (Genética - Detoxificação)

**30 chunks de 13 artigos (avg similarity: 0.577)**
...
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.563
