# ScoreItem: Desvios penianos

**ID:** `c77cedd3-2800-7baf-8756-f0cab6268e1b`
**FullName:** Desvios penianos (Histórico de doenças - Histórico de saúde (Questionar ativamente sobre doenças/sintomas - passado ou atual):)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7baf-8756-f0cab6268e1b`.**

```json
{
  "score_item_id": "c77cedd3-2800-7baf-8756-f0cab6268e1b",
...
**ScoreItem:** Desvios penianos (Histórico de doenças - Histórico de saúde (Questionar ativamente sobre doenças/sintomas - passado ou atual):)

**30 chunks de 7 artigos (avg similarity: 0.590)**
...
*   **Doenças Crônicas:** Diabetes, doenças cardiovasculares (doença aterosclerótica), resistência à insulina, síndrome metabólica, obesidade (circunferência abdominal > 94 cm), hipogonadismo (baixos níveis de testosterona), doença de Peyronie, depressão e ansiedade.
    *   **Estilo de Vida:** Sedentarismo, tabagismo, alcoolismo, uso e abuso de drogas, estresse diário, má qualidade do sono (especialmente apneia obstrutiva do sono) e dieta inadequada (rica em alimentos ultraprocessados, carboidratos refinados, óleos vegetais de sementes com excesso de ômega 6).
    *   **Deficiências Nutricionais:** Deficiência de Vitamina D (níveis < 20 ng/ml) e de ácido fólico são fatores de risco independentes.
    *   **Exposição a Agentes Tóxicos:** Pesticidas, metais pesados, xenoestrógenos (BPA, microplásticos).
