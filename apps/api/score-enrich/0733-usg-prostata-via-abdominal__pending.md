# ScoreItem: USG próstata (via abdominal)

**ID:** `c77cedd3-2800-7947-a99e-5a99e96ced70`
**FullName:** USG próstata (via abdominal) (Exames - Imagem)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7947-a99e-5a99e96ced70`.**

```json
{
  "score_item_id": "c77cedd3-2800-7947-a99e-5a99e96ced70",
...
**ScoreItem:** USG próstata (via abdominal) (Exames - Imagem)

**30 chunks de 11 artigos (avg similarity: 0.638)**

### Chunk 1/30
**Article:** Terapia de Reposição Hormonal com Testosterona XII (2024)
**Journal:** Pos Graduacao MFI
**Section:** results | **Similarity:** 0.775
...
**Article:** Terapia de Reposição Hormonal com Testosterona XII (2024)
**Journal:** Pos Graduacao MFI
**Section:** other | **Similarity:** 0.749
...
**Section:** abstract | **Similarity:** 0.616
...
- Inibidor de 5-alfa-redutase principal: Saw Palmetto (Serenoa repens), seguro e bem estudado, especialmente para hiperplasia prostática benigna.
- Doses de Saw Palmetto: 200-400 mg, podendo iniciar com 150 mg e ajustar conforme a necessidade.
- É crucial avaliar a sensibilidade individual do paciente ao DHT (histórico de acne, queda de cabelo, etc.) antes de iniciar terapias que possam aumentá-lo (como com gestrinona).
- Outra opção é o Actrisave (patente da Galena), uma combinação de arroz negro e Opuntia ficus, que também inibe o DHT.
- Alerta crítico: inibir o DHT (com Saw Palmetto ou Actrisave) desvia a testosterona para a via do estradiol. Portanto, é obrigatório o acompanhamento com exames hormonais.
> **Sugestões da IA**
> A explicação sobre o Saw Palmetto foi clara e direta.
...
ticas, técnicas de aplicação (IM vs. SC em gordura) e considerações sobre fertilidade (inibição do eixo HPT), PSA e saúde prostática. Paralelamente, aborda-se modulação de estrógenos com indol-3-carbinol e DIM baseados em achados do DUT test, testosterona em mulheres para desejo sexual hipoativo (doses baixas e cautelas), uso criterioso de gestrinona (preferência por creme vaginal antes de implante), limites profissionais e necessidade de co-manejo com urologistas. Diferenciam-se reposição hormonal de uso anabolizante, destacando-se riscos, ética, contaminação de suplementos e a primazia da correlação clínica sobre “valores ideais” fixos. A gravação foi analisada em 2025-11-21; referências temporais foram interpretadas literalmente.
## 🔖 Pontos de Conhecimento
### 1. Modalidades injetáveis de TRT e aceitação clínica
- Undecilato de testosterona (Nebido e genéricos)
  - Éster de liberação lenta; aplicação trimestral na bula.
