# ScoreItem: CDKAL1 rs7754840 (Diabetes)

**ID:** `019c1a2b-a36f-7a56-90a1-bb461474a16d`
**FullName:** CDKAL1 rs7754840 (Diabetes) (Genética - Metabolismo)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7a56-90a1-bb461474a16d`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7a56-90a1-bb461474a16d",
...
**ScoreItem:** CDKAL1 rs7754840 (Diabetes) (Genética - Metabolismo)

**30 chunks de 18 artigos (avg similarity: 0.581)**
...
ignaling.Sci.STKE2003,2003,PE6.[CrossRef][PubMed]75.Zick,Y.Insulinresistance:Aphosphorylation-baseduncouplingofinsulinsignaling.TrendsCellBiol.2001,11,437–441.[CrossRef]76.Ha,J.;Satin,L.S.;Sherman,A.S.AMathematicalModelofthePathogenesis,Prevention,andReversalofType2Diabetes.Endocrinology2016,157,624–635.[CrossRef]77.Corkey,B.E.Diabetes:Havewegotitallwrong?Insulinhypersecretionandfoodadditives:Causeofobesityanddiabetes?DiabetesCare2012,35,2432–2437.[CrossRef]78.Ramlo-Halsted,B.A.;Edelman,S.V.Thenaturalhistoryoftype2diabetes.Implicationsforclinicalpractice.Prim.Care1999,26,771–789.[CrossRef]79.Billings,L.K.;Florez,J.C.Thegeneticsoftype2diabetes:WhathavewelearnedfromGWAS?Ann.N.Y.Acad.Sci.2010,1212,59–77.[CrossRef]80.Ferrannini,E.;Gastaldelli,A.;Miyazaki,Y.;Matsuda,M.;Mari,A.;DeFronzo,R.A.beta-Cellfunctioninsubjectsspanningtherangefromnormalglucosetolerancetoovertdiabetes:Anewanalysis.J.Clin.Endocrinol.Metab.2005,90,493–500.[CrossRef]81.Pories,W.J.;Dohm,G.L.Diabetes:Havewegotit
...
* **Resistência à Vitamina D:** Esses polimorfismos podem gerar resistência aos efeitos biológicos da vitamina D, justificando doses mais altas em alguns casos.
* **Associações Específicas:** Há vínculos entre polimorfismos genéticos e doenças como:
    * Artrite reumatoide (associada a vias de metilação).
    * Diabetes tipo 1 (associado a polimorfismos da CYP27B1).
    * Doença de Graves e Tireoidite de Hashimoto.
    * Doença de Addison.
### Protocolo com Altas Doses de Vitamina D: Evidências e Casos Clínicos
Apesar da escassez de ensaios clínicos randomizados em larga escala para altas doses, a prática clínica mostra resultados relevantes ("alegações extraordinárias exigem evidências extraordinárias", Carl Sagan). O Protocolo Coimbra aplica altas doses de vitamina D em diversas condições.
#### **Psoríase**
* **Estudo piloto (2012, Dr.
