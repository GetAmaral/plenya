# ScoreItem: FMI - Fat Mass Index (kg/m²) - mulher

**ID:** `019bf31d-2ef0-73ff-8438-c24fa0876d10`
**FullName:** FMI - Fat Mass Index (kg/m²) - mulher (Composição corporal - Atual - Medidas objetivas)
**Gender:** female
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-73ff-8438-c24fa0876d10`.**

```json
{
  "score_item_id": "019bf31d-2ef0-73ff-8438-c24fa0876d10",
...
**ScoreItem:** FMI - Fat Mass Index (kg/m²) - mulher (Composição corporal - Atual - Medidas objetivas)
**Gênero:** female

**30 chunks de 15 artigos (avg similarity: 0.611)**
...
**Article:** Emagrecimento - Parte I (2024)
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.637
...
**Article:** Emagrecimento - Parte I (2024)
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.633
