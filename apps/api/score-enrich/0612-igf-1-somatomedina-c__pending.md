# ScoreItem: IGF-1 (Somatomedina C)

**ID:** `019bf31d-2ef0-7671-8ed0-049b3b41cfc4`
**FullName:** IGF-1 (Somatomedina C) (Exames - Laboratoriais)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7671-8ed0-049b3b41cfc4`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7671-8ed0-049b3b41cfc4",
...
**ScoreItem:** IGF-1 (Somatomedina C) (Exames - Laboratoriais)

**30 chunks de 5 artigos (avg similarity: 0.647)**
...
Associação entre catecolaminas, lipólise induzida pelo exercício e GH na prática clínica.
3. Detalhes sobre os carreadores de IGF-1 (IGF-BP3).
4. Como detectar a deficiência de GH (testes de estímulo vs. avaliação basal).
5. O papel do exercício de alta intensidade na reversão das alterações enzimáticas na obesidade.
6. A relação entre exercício, respostas hormonais (GH, IGF-1, testosterona) e hipertrofia muscular.
