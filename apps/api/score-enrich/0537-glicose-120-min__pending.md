# ScoreItem: GLICOSE 120 MIN

**ID:** `019bf31d-2ef0-7e94-a2a1-596a2a3cdf44`
**FullName:** GLICOSE 120 MIN (Exames - Laboratoriais)
**Unit:** mg/dL
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7e94-a2a1-596a2a3cdf44`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7e94-a2a1-596a2a3cdf44",
...
**ScoreItem:** GLICOSE 120 MIN (Exames - Laboratoriais)
**Unidade:** mg/dL

**30 chunks de 13 artigos (avg similarity: 0.578)**
...
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.557
