# ScoreItem: FADS1 rs174546 (Ômega-3)

**ID:** `019c1a2b-a36f-731c-9ae6-8baa13de38a1`
**FullName:** FADS1 rs174546 (Ômega-3) (Genética - Metabolismo)

**Preparation Metadata:**
- Quality Grade: **EXCELLENT**
- Total Chunks: 30 de 13 artigos
- Avg Similarity: 0.651
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-731c-9ae6-8baa13de38a1`.**

```json
{
  "score_item_id": "019c1a2b-a36f-731c-9ae6-8baa13de38a1",
...
**ScoreItem:** FADS1 rs174546 (Ômega-3) (Genética - Metabolismo)

**30 chunks de 13 artigos (avg similarity: 0.651)**
...
**Article:** Ácidos Graxos Poliinsaturados (2024)
**Journal:** Pos Graduacao MFI
**Section:** introduction | **Similarity:** 0.698
...
metiladas, conforme polimorfismos de enzimas-chave (FADS1/2, FABP2, MTHFR, FUT1), garantindo que a intervenção atravesse gargalos metabólicos individuais em vez de seguir recomendações padronizadas.
**Significado & Evolução:**
O conceito começa ao questionar doses universais e a crença na conversão metabólica eficiente para todos. A seguir, introduz a lógica de encaixe funcional gene-enzima-nutriente: quando há polimorfismos em dessaturases ou vias de metilação, a eficácia depende de ofertar diretamente o produto ativo (EPA/DHA, metilfolato/metilcobalamina) ou contornar a etapa deficiente. No nível mais avançado, transforma suplementos em terapias dirigidas, propondo triagens genéticas mínimas, algoritmos de decisão e diálogo ético-prático (como alternativas para veganos com FADS) e integração com outros eixos (p. ex., mitocôndrias).
...
uilíbrios (excesso de saturados longos e ômega-6; falta de SCFA/MCFA, MUFA, PUFA ômega-3).
- Diversidade lipídica favorece funções de membrana, sinalização e metabolismo; parâmetros laboratoriais isolados podem não capturar deficiências funcionais, sendo útil integrar análises avançadas como metabolômica.
### 10. Individualização e doses de ômega-3
- Suplementação pode falhar se não houver ajustes de estilo de vida, dieta e dose; estudos tornam-se inconclusivos quando não individualizam (1 g vs. 3–5 g) conforme condição clínica, dieta e marcadores.
- Critérios práticos e fluxogramas decisórios serão aprofundados em conteúdos pendentes.
### 11. Contexto histórico de recomendações sobre gorduras e óleos
- De observações antigas de ateroma e estudos em coelhos à influência de Ancel Keys (1953), políticas públicas favoreceram óleos vegetais/processados.
