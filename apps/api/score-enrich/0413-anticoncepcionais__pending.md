# ScoreItem: Anticoncepcionais

**ID:** `c77cedd3-2800-7f39-a8fd-1332fa906fa5`
**FullName:** Anticoncepcionais (Histórico de doenças - Medicamentos)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7f39-a8fd-1332fa906fa5`.**

```json
{
  "score_item_id": "c77cedd3-2800-7f39-a8fd-1332fa906fa5",
...
**ScoreItem:** Anticoncepcionais (Histórico de doenças - Medicamentos)

**30 chunks de 16 artigos (avg similarity: 0.631)**
