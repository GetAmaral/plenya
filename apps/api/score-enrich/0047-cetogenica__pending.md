# ScoreItem: Cetogênica

**ID:** `c77cedd3-2800-7f39-89b7-5b249a004d08`
**FullName:** Cetogênica (Alimentação - Atual (últmos 6 meses) - Padrão alimentar atual)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7f39-89b7-5b249a004d08`.**

```json
{
  "score_item_id": "c77cedd3-2800-7f39-89b7-5b249a004d08",
...
**ScoreItem:** Cetogênica (Alimentação - Atual (últmos 6 meses) - Padrão alimentar atual)
...
stão de colina é frequentemente insuficiente em gestantes, em parte devido à demonização de alimentos como ovos e carnes.
    - A suplementação recomendada parte de, no mínimo, 250 mg/dia, podendo chegar a 1g/dia, preferencialmente na forma de fosfatidilcolina.
*   **Zinco, Cobre e Magnésio**
    - O equilíbrio entre zinco e cobre é crucial. Um nível alto de cobre e baixo de zinco é comum em mulheres com dificuldade para engravidar.
    - Um estudo de longo prazo mostrou que alto cobre e baixo magnésio estão associados a maior risco de mortalidade cardiovascular.
    - A combinação protetora foi: cobre baixo (quartil inferior), zinco mediano para alto (terceiro quartil) e magnésio alto.
    - O sulfato ferroso, comumente prescrito, compete com o zinco e aumenta o estresse oxidativo.
...
**Section:** other | **Similarity:** 0.603
 ...
 o pode reduzir risco de parto prematuro e alergias na infância, além de aumentar modestamente o peso ao nascer.
    - Ômega-3 é essencial e sua suplementação se justifica pela deficiência dietética.
*   **Fontes e suplementação de ômega-3**
    - A conversão de ALA (linhaça) em EPA e DHA é muito limitada.
    - Vegetarianos e veganos (sem consumo de peixe) tendem a ter níveis mais baixos de EPA/DHA e devem ser convencidos a suplementar.
    - Para veganos, DHA derivado de algas é preferível a não suplementar.
### 3. Obesidade e Síndrome dos Ovários Policísticos (SOP)
*   **Impacto da obesidade na fertilidade e gestação**
    - Principal fator de risco gestacional: altera metilação, aumenta resistência à insulina, inflamação e oxidação.
    - Obesidade nos pais associa-se a parto prematuro, espermatogênese prejudicada e menor sucesso gestacional.
