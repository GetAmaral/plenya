# ScoreItem: Água corporal total (%) - homem

**ID:** `019bf31d-2ef0-79d7-b34c-6903192383d5`
**FullName:** Água corporal total (%) - homem (Composição corporal - Atual - Medidas objetivas)
**Gender:** male
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-79d7-b34c-6903192383d5`.**

```json
{
  "score_item_id": "019bf31d-2ef0-79d7-b34c-6903192383d5",
...
**ScoreItem:** Água corporal total (%) - homem (Composição corporal - Atual - Medidas objetivas)
**Gênero:** male

**30 chunks de 15 artigos (avg similarity: 0.494)**
...
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.535
...
**Article:** Serum sodium within the normal range and its U-shaped relationship with biological aging in U.S. adults (2026)
**Journal:** Revista não identificada
**Section:** methods | **Similarity:** 0.505
...
**Section:** abstract | **Similarity:** 0.482
