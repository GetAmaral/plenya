# ScoreItem: Água extracelular (L)

**ID:** `019bf31d-2ef0-701f-bf42-8db8a3af264b`
**FullName:** Água extracelular (L) (Composição corporal - Atual - Medidas objetivas)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-701f-bf42-8db8a3af264b`.**

```json
{
  "score_item_id": "019bf31d-2ef0-701f-bf42-8db8a3af264b",
...
**ScoreItem:** Água extracelular (L) (Composição corporal - Atual - Medidas objetivas)
