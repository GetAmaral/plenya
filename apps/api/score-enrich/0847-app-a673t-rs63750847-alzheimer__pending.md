# ScoreItem: APP A673T rs63750847 (Alzheimer)

**ID:** `019c1a2b-a36f-7d0d-9cad-2f35e3961089`
**FullName:** APP A673T rs63750847 (Alzheimer) (Genética - Neurodegeneração)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7d0d-9cad-2f35e3961089`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7d0d-9cad-2f35e3961089",
...
**ScoreItem:** APP A673T rs63750847 (Alzheimer) (Genética - Neurodegeneração)

**30 chunks de 13 artigos (avg similarity: 0.593)**
...
is muito baixos (< 150 mg/dL) podem ser um fator de risco.
-   **Outros Fatores de Risco:**
    -   **Metais Tóxicos:** Mercúrio, chumbo, cádmio, arsênico.
    -   **Sono:** Apneia e privação de sono.
    -   **Saúde Intestinal:** Permeabilidade intestinal (Leaky Gut) e sensibilidade ao glúten.
    -   **Infecções Ocultas:** Mofo, infecções orais e sinusais.
    -   **Gordura Visceral:** Medida pela circunferência da cintura.
    -   **Produtos Finais da Glicação Avançada (AGEs):** De alimentos fritos, assados e grelhados.
**Fisiopatologia:**
-   A doença começa no hipocampo e se expande. Neurônios involuem, perdem sinapses e formam emaranhados neurofibrilares (proteína tau) e placas amiloides (proteína beta-amiloide).
-   A deposição de amiloide é vista como uma reação protetora a insultos crônicos (inflamatórios, glicêmicos, hormonais), mas que acaba perpetuando a doença.
