# ScoreItem: LIPC rs1800588 (HDL)

**ID:** `019c1a2b-a36f-7282-bd0b-404176b31b0c`
**FullName:** LIPC rs1800588 (HDL) (Genética - Cardiovascular)

**Preparation Metadata:**
- Quality Grade: **EXCELLENT**
- Total Chunks: 30 de 11 artigos
- Avg Similarity: 0.636
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7282-bd0b-404176b31b0c`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7282-bd0b-404176b31b0c",
...
**ScoreItem:** LIPC rs1800588 (HDL) (Genética - Cardiovascular)

**30 chunks de 11 artigos (avg similarity: 0.636)**
...
**Article:** Cardiologia II (2024)
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.651
