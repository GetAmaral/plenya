# ScoreItem: GSTT1 (Detoxificação)

**ID:** `019c1a2b-a36f-7581-b3a6-19d4e16efd0f`
**FullName:** GSTT1 (Detoxificação) (Genética - Detoxificação)

**Preparation Metadata:**
- Quality Grade: **EXCELLENT**
- Total Chunks: 30 de 15 artigos
- Avg Similarity: 0.604
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7581-b3a6-19d4e16efd0f`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7581-b3a6-19d4e16efd0f",
...
**ScoreItem:** GSTT1 (Detoxificação) (Genética - Detoxificação)

**30 chunks de 15 artigos (avg similarity: 0.604)**
...
ompostos como N-acetilcisteína (NAC), glisodin, silimarina e coenzima Q10 (ubiquinona/ubiquinol). A aula incluiu suas fontes alimentares, formas de suplementação, dosagens, interações e importância clínica. Por fim, foi apresentado um exemplo de análise de polimorfismos genéticos (GPX1, CBS, ALDH2, NQO1), suas implicações e estratégias de manejo, incluindo uma crítica ao uso indiscriminado de estatinas.
## Conteúdo Remanescente
1.  Explicação detalhada do metabolismo do ferro.
2.  Entendimento do trato digestivo e o efeito antiácido do óxido de magnésio.
3.  Detalhes sobre os módulos de polimorfismo genético.
4.  Explicação completa dos genes alterados no exemplo do paciente (GPX1, etc.).
5.  Glicação (a ser abordada na próxima aula).
6.  Estudo aprofundado do resveratrol no sistema intestinal.
...
com uma análise detalhada de suas diferentes formas de suplementação e biodisponibilidade. A palestra também aborda a N-acetilcisteína (NAC) como precursora da glutationa, a coenzima Q10 (e sua forma ativa, ubiquinol), e fitoterápicos como a silimarina. O instrutor critica a abordagem da medicina tradicional, que foca nos sintomas em vez das causas, e o uso indiscriminado da soroterapia. A palestra conclui com um exemplo prático de análise de polimorfismos genéticos (como ALDH2, MTHFR, NQO1) relacionados ao estresse oxidativo, utilizando o próprio perfil genético do instrutor para ilustrar como deficiências genéticas podem impactar a capacidade antioxidante do corpo e como a suplementação pode ser personalizada.
## 🔖 Pontos de Conhecimento
### 1.
...
### 6. Genética, testes e personalização do tratamento
- Testes genéticos
  - COMT (Val/Val “GG”, Met/Met “AA”), MAO, tirosina hidroxilase, DBH, ALDH2, HCRT1/2 e HCRTR1/2.
- Marcadores bioquímicos
  - Urina: 3-MT, DOPAC, HVA; LCR e sangue (menor grau) para 3-MT; homocisteína para metilação.
- Prática clínica
  - Combinar genótipos com expressão fenotípica e marcadores para ajustar fármacos/suplementos.
  - Medicina funcional integrativa: interpreta polimorfismos e gatilhos ambientais para terapia de precisão.
### 7. Evidências e interação gene-ambiente no TDAH
- Estudos
  - Evidência (2020) de maior risco/gravidade de TDAH em MET (AA), especialmente impulsividade/desatenção.
- Ambiente moderno
  - Telas, aditivos e sedentarismo desorganizam energia em COMT lenta e dificultam foco em ambientes de imobilidade (escola).
