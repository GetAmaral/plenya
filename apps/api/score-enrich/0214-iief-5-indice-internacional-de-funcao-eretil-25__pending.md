# ScoreItem: IIEF-5 (Índice Internacional de Função Erétil): ____/25

**ID:** `c77cedd3-2800-7e5e-b7c0-bd312f6a7ed4`
**FullName:** IIEF-5 (Índice Internacional de Função Erétil): ____/25 (Vida Sexual - Atual - Escalas de desempenho:)

**Preparation Metadata:**
- Quality Grade: **EXCELLENT**
- Total Chunks: 30 de 5 artigos
- Avg Similarity: 0.640
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7e5e-b7c0-bd312f6a7ed4`.**

```json
{
  "score_item_id": "c77cedd3-2800-7e5e-b7c0-bd312f6a7ed4",
...
**ScoreItem:** IIEF-5 (Índice Internacional de Função Erétil): ____/25 (Vida Sexual - Atual - Escalas de desempenho:)

**30 chunks de 5 artigos (avg similarity: 0.640)**
...
m 73% dos pacientes relatando que seus médicos não abordam o tema, apesar de 81% desejarem discuti-lo. A condição está fortemente ligada a fatores de risco de estilo de vida, como circunferência abdominal acima de 94 cm e sedentarismo, mas também pode ser significativamente melhorada através de intervenções como exercícios aeróbicos (160 minutos por semana) e suplementação nutricional direcionada.
---
### Evidências Principais
**A disfunção erétil é uma condição comum e subnotificada, com mais da metade dos homens em um grande estudo brasileiro apresentando algum grau do problema, enquanto 73% dos pacientes nunca foram questionados sobre o tema por um médico nos últimos três anos.**
- Um estudo com mais de 71.000 pacientes no Brasil revelou que mais da metade dos entrevistados sofre de algum grau de disfunção erétil.
- Apesar da alta prevalência, 73% dos pacientes afirmaram que nenhum médico abordou o assunto com eles nos últimos três anos.
...
*   **Prescrição:**
    ...
    *   **Suplementação para Potencializar PDE5:** Arginina (aprox. 500 mg/dia) e L-carnitina (500 mg a 1 g/dia).
    *   **Suplementação para Estresse Oxidativo:** N-acetilcisteína, ácido glutâmico, glicina, Vitamina C, ácido alfa-lipoico, selênio, Vitamina E, Riboflavina (100-200 mg/dia).
    *   **Correção de Deficiências:** Suplementação de Vitamina D (para atingir níveis > 40 ng/ml) e Ácido Fólico.
    *   **Terapia Hormonal:** Reposição de testosterona para homens com hipogonadismo confirmado.
    *   **Fitoterápicos:** Tribulus terrestris (até 1-1,5 g/dia) pode ser considerado para casos leves.
...
**Source:** https://web.plaud.ai/share/f9f31765255765432::YXdzOnVzLXdlc3QtMg

---

## Lecture

> 21 de novembro de 2025 04:18:00: 2025-11-21 01:18:00
> Local: [Inserir Local]
> Instrutor: Fernando Bastos
## 📝 Resumo
A aula/palestra, ministrada pelo urologista e andrologista Fernando Bastos, apresenta a disfunção erétil (DE) como um sintoma de doença sistêmica multifatorial, altamente prevalente e com impacto profundo na qualidade de vida, nas relações e no desempenho profissional. Com base em evidências brasileiras de grande escala (mais de 71 mil entrevistados, >50% com algum grau de DE) e em estudos internacionais, reforça-se o subdiagnóstico clínico (73% não foram indagados sobre impotência em 3 anos; 81% gostariam que o tema fosse abordado) e o risco triplicado de depressão em homens com DE.
A DE é discutida como marcador precoce de disfunção endotelial e risco cardiovascular, frequentemente antecedendo eventos cardíacos em meses.
...
sco triplicado de depressão em homens com DE.
A DE é discutida como marcador precoce de disfunção endotelial e risco cardiovascular, frequentemente antecedendo eventos cardíacos em meses. O conteúdo integra mecanismos fisiopatológicos (endotélio, óxido nítrico–GMPc, estado autonômico), fatores de risco orgânicos (resistência à insulina, obesidade, síndrome metabólica, diabetes, apneia obstrutiva do sono, hipogonadismo, tabagismo, álcool, drogas, exposições ambientais e medicamentos) e causas emocionais (ansiedade de desempenho, depressão, pornografia e relações virtuais em jovens). Defende-se uma abordagem pela medicina funcional integrativa, que trata causas metabólicas, hormonais, inflamatórias, ambientais e comportamentais ao lado do manejo sintomático (PDE5i), usando avaliação clínica ampla (anamnese, estilo de vida, sono, composição corporal, exame físico direcionado, exames laboratoriais e de imagem).
...
os, xenoestrógenos (BPA, microplásticos).
    *   **Cirurgias Prévias:** Cirurgias perineais, testiculares, inguinais, prostáticas ou em baixo ventre.
    *   **Outros:** Capacidade cardiopulmonar reduzida, presença de ginecomastia e histórico de COVID-19.
2.  **Histórico de Medicação:** Vários medicamentos podem impactar negativamente a função sexual, incluindo:
    *   **Urológicos:** Inibidores da 5-alfa-redutase como Finasterida e Dutasterida.
    *   **Neuropsiquiátricos:** Escitalopram, Fluoxetina, Quetiapina, Venlafaxina e Lisdexanfetamina (Vyvanse).
    *   **Cardiológicos:** Estatinas (Sinvastatina, Atorvastatina), anti-hipertensivos (Anlodipino), betabloqueadores (Propranolol) e diuréticos (Hidroclorotiazida).
    *   **Dermatológicos:** Medicamentos não especificados que podem causar disfunção erétil.
## Subjetivo:
A disfunção erétil é um sintoma de uma doença sistêmica, com causas frequentemente mistas (orgânicas e emocionais).
...
da ereção
- Apneia do sono: hipoxemia reduz NO e GMPc; aumenta endotelina; diminui ereções matinais e testosterona; piora IIEF.
- Hipogonadismo/testosterona: declínio progressivo a partir dos 30 anos; níveis baixos (<200 ng/dL) associados a menor tumescência; reposição melhora ereção (especialmente leve–moderada) e resposta a PDE5i, além de libido.
- Mecanismo NO–GMPc e PDE5i: arginina → NO → GMPc → ↓Ca2+ → relaxamento cavernoso → ereção; PDE5 degrada GMPc; PDE5i sustentam GMPc e a ereção.
### 12. COVID-19 e DE
- Pós-COVID: aumento de casos por estresse oxidativo e eventos trombóticos; recuperação típica em 6–12 meses; tendência recente de queda.
### 13. Descompasso evolutivo e estratégia terapêutica
- O organismo humano não acompanhou mudanças rápidas do ambiente moderno (sedentarismo, ultraprocessados, tóxicos); isso contribui para epidemia de DE e doenças crônicas.
...
refinados.
        *   **Atividade Física:** Incentivar exercícios aeróbicos de intensidade leve a vigorosa, pelo menos 40 minutos, 4 vezes por semana (total de 160 min/semana).
    *   **Gerenciamento de Estresse:** Promover um estado parassimpático (relaxamento).
    *   **Terapia:** Para pacientes com causas emocionais, recomenda-se terapia sexual concomitante.
    *   **Abordagem Mista:** Tratar a doença de base (obesidade, diabetes, etc.) para estabilizar ou regredir o problema, enquanto se trata o sintoma com medicamentos para permitir relações sexuais satisfatórias, quebrando o ciclo da causa emocional e estimulando a adesão ao tratamento.
...
A disfunção erétil é um problema de saúde prevalente e subdiagnosticado, com 73% dos pacientes relatando que seus médicos não abordam o tema, apesar de 81% desejarem discuti-lo.
...
valiar hipogonadismo e iniciar reposição de testosterona quando indicado e seguro.
- [ ] Selecionar PDE5i conforme perfil do paciente; checar contraindicações (nitratos, retinite pigmentar, isquemia de retina).
- [ ] Integrar terapia sexual para causas emocionais; na falha de PDE5i, manter tratamento causal e encaminhar para segunda linha (tópicos/injetáveis).
- [ ] Agendar retorno para revisão de exames e reabordagem do tema sexual, considerando a tendência do paciente a relatar indiretamente na primeira consulta.

---

## SOAP

Data e Hora: 2025-11-21 01:18:00
Paciente: 
Diagnóstico:
## Histórico de Diagnóstico:
1.  **Histórico Médico:** A disfunção erétil é frequentemente um sintoma de doenças crônicas sistêmicas.
...
ntes com menos de 40 anos, enquanto causas orgânicas se tornam mais comuns acima dessa idade.
- Níveis de testosterona abaixo de 200 nanogramas por decilitro estão associados a uma redução nas ereções matinais, e o declínio natural da testosterona geralmente começa por volta dos 30 anos.
- Medicamentos como a Finasterida (usada em doses de 1mg ou 5mg) e a Dutasterida (0,5mg) podem impactar a função sexual, sendo a dose de 0,5mg de Dutasterida considerada mais potente que 5mg de Finasterida.
- A disfunção erétil pode se manifestar, em média, 6 meses antes de eventos cardiovasculares, servindo como um sinal de alerta precoce.
- Pacientes pós-COVID podem levar de 6 meses a 1 ano para recuperar totalmente a função sexual.
- Uma mudança na dieta nos últimos 150 anos, com aumento do consumo de óleos ricos em ômega 6, gerou um estado inflamatório crônico que impacta a saúde geral.
...
trevistados sofre de algum grau de disfunção erétil.
- Apesar da alta prevalência, 73% dos pacientes afirmaram que nenhum médico abordou o assunto com eles nos últimos três anos.
- Isso contrasta com o desejo dos pacientes, já que 81% gostariam que seus médicos iniciassem essa conversa.
- O Dr. Fernando Bastos, com mais de 20 anos de experiência, destaca a importância do diagnóstico, que pode ser auxiliado pelo questionário "Índice Internacional de Função Erétil", composto por seis perguntas.
**Fatores de risco metabólicos e de estilo de vida aumentam drasticamente a probabilidade de disfunção erétil, com a circunferência abdominal acima de 94 cm, diabetes e síndrome metabólica elevando o risco em até 3,5 vezes.**
- Homens com circunferência abdominal acima de 94 cm apresentam risco aumentado de problemas cardiovasculares, enquanto acima de 102 cm, o risco de impotência triplica para homens com mais de 60 anos.
...
ento
### 1. Fatores inflamatórios e lesão endotelial
- Endotélio e placa como alvos de lesão:
  - Fatores inflamatórios lesam endotélio e placa aterosclerótica de modo muitas vezes assintomático e negligenciado: desequilíbrio ômega 3/ômega 6; PCR elevada; hiperinsulinemia; baixa NO; deficiência de hormônio D; LDL oxidado; hipertensão; homocisteína; fibrinogênio; ferritina elevada; baixa testosterona; hipertrigliceridemia.
- Disfunção erétil como marcador:
  - Em homens, indica possível lesão endotelial sistêmica e alto risco cardiovascular por dependência de NO em vasos penianos finos.
### 2. Ácidos graxos ômega 3 e ômega 6
- Equilíbrio inflamação/anti-inflamação e oxidação/antioxidação:
  - Proporção entre ômega 3 e ômega 6 modula processos que impactam endotélio e lipoproteínas; excesso de ômega 6 na dieta moderna é relevante.
...
oico, selênio, vitamina E; riboflavina 100–200 mg/dia (cofator da glutationa redutase).
  - Aminoácidos: arginina (apoio ao NO e sinergia com PDE5i), L‑carnitina (500 mg–1 g/dia) útil em não respondedores.
  - Fitoterapia: Tribulus pode ajudar em DE leve, mas com baixa previsibilidade; cautela com doses altas; Maca com efeito discreto.
- Otimização hormonal: avaliar e tratar hipogonadismo quando indicado; reposição de testosterona melhora ereção e libido e resgata resposta a PDE5i em casos de baixa testosterona.
### 15. Manejo sintomático e escalonamento
- PDE5i (sildenafila, vardenafila, tadalafila): diferenças de meia-vida, interação com alimentos e efeitos adversos; contraindicações formais com nitratos, retinite pigmentar e isquemia de retina.
- Segunda linha: tópicos/injetáveis quando falha de PDE5i; manter abordagem causal e encaminhar a especialista.
