# ScoreItem: Hemograma completo

**ID:** `019bf31d-2ef0-713f-9338-73a98cef11f1`
**FullName:** Hemograma completo (Exames - Laboratoriais)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-713f-9338-73a98cef11f1`.**

```json
{
  "score_item_id": "019bf31d-2ef0-713f-9338-73a98cef11f1",
...
**ScoreItem:** Hemograma completo (Exames - Laboratoriais)

**30 chunks de 18 artigos (avg similarity: 0.582)**
...
**Article:** Mitocôndrias - Parte V (2024)
**Journal:** Pos Graduacao MFI
**Section:** conclusion | **Similarity:** 0.567
