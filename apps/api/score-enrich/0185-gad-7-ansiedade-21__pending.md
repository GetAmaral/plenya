# ScoreItem: GAD-7 (ansiedade): ___/21

**ID:** `c77cedd3-2800-78a5-a272-01c1e573fcc0`
**FullName:** GAD-7 (ansiedade): ___/21 (Cognição - Atual - Presença de sintomas de tristeza/depressão/ansiedade)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-78a5-a272-01c1e573fcc0`.**

```json
{
  "score_item_id": "c77cedd3-2800-78a5-a272-01c1e573fcc0",
...
**ScoreItem:** GAD-7 (ansiedade): ___/21 (Cognição - Atual - Presença de sintomas de tristeza/depressão/ansiedade)

**30 chunks de 11 artigos (avg similarity: 0.639)**
