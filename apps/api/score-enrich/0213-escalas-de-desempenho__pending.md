# ScoreItem: Escalas de desempenho:

**ID:** `c77cedd3-2800-7fb6-99ad-dd12f4e9e919`
**FullName:** Escalas de desempenho: (Vida Sexual - Atual)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7fb6-99ad-dd12f4e9e919`.**

```json
{
  "score_item_id": "c77cedd3-2800-7fb6-99ad-dd12f4e9e919",
...
**ScoreItem:** Escalas de desempenho: (Vida Sexual - Atual)

**30 chunks de 6 artigos (avg similarity: 0.697)**

### Chunk 1/30
**Article:** DISFUNÇÃO ERÉTIL (2024)
**Journal:** Pos Graduacao MFI
**Section:** results | **Similarity:** 0.787
...
**Article:** DISFUNÇÃO ERÉTIL (2024)
**Journal:** Pos Graduacao MFI
**Section:** other | **Similarity:** 0.768
...
**Article:** DISFUNÇÃO ERÉTIL (2024)
**Journal:** Pos Graduacao MFI
**Section:** other | **Similarity:** 0.743
...
**Journal:** Pos Graduacao MFI
**Section:** discussion | **Similarity:** 0.713
...
**Journal:** Pos Graduacao MFI
**Section:** results | **Similarity:** 0.702
...
ápidas do ambiente moderno (sedentarismo, ultraprocessados, tóxicos); isso contribui para epidemia de DE e doenças crônicas.
- Estratégia: recriar condições próximas ao ambiente ancestral com nutrição adequada, movimento regular, exposição reduzida a tóxicos e manejo do estresse.
### 14. Nutrição, suplementação e otimização hormonal
- Nutrição: base em proteínas e gorduras de qualidade, vegetais variados; reduzir ultraprocessados, farináceos, refinados e óleos de sementes ricos em ômega-6.
- Suplementação:
  - Vitamina D: deficiência comum; níveis >40 ng/mL associam-se a melhor função endotelial e sexual.
  - Folato: deficiência correlacionada à DE em meta-análise.
  - Antioxidantes e glutationa: NAC, glicina, ácido glutâmico; vitamina C, ácido alfa-lipoico, selênio, vitamina E; riboflavina 100–200 mg/dia (cofator da glutationa redutase).
...
* Tratamento da causa-base
   ...
   - Integração multiprofissional: nutricionista é central; encaminhamento obrigatório quando necessário. Evitar abordagens simplistas (“low carb” isolado).
* Papel da testosterona em sinais e sintomas
   - Disfunção erétil e queda de libido são apenas parte de ampla gama de sinais; ausência desses não exclui necessidade de otimização, dado papel anabólico e de reparo celular (>200 funções).
   - Crítica à prática clínica desconectada: prescrição de Viagra/Cialis sem avaliação hormonal é inadequada quando há suspeita de disfunção hormonal.
### 5.

---

### Chunk 26/30
**Article:** Abordagem Funcional Integrativa Aplicada a Cada Área - Parte V (2024)
**Journal:** Pos Graduacao MFI
**Section:** other | **Similarity:** 0.655

 til associado à semaglutida inclui mapeamento a itens sobre DE, uso de PDE5 em 1,4% e risco 10x, com destaque para homens não diabéticos.
- Deficiência de testosterona associada à semaglutida foi mapeada em 3,83%.
- Critérios de exclusão do estudo: homens de 18–50 anos; HbA1c >7% excluído, concentrando evidência em não diabéticos.
**A fertilidade masculina apresenta queda acentuada ao longo de décadas, aumentando a relevância de intervenções.**
- Declínio da concentração de espermatozoides de 52,4% em 40 anos.
- Declínio da contagem total de espermatozoides de 59,3% em 40 anos.
- Faixa etária dos participantes nos estudos de 25–48 anos, com subgrupo ≥40 anos, alinhando a tendência de queda com populações estudadas.
**Ashwagandha, em doses moderadas a altas por até 90 dias, melhora marcadamente parâmetros seminais.**
- Faixas de dose: 240–1000 mg/dia, com efeitos frequentemente em ≥600 mg/dia; referência máxima citada de 12.000 mg/dia (12 g).

---

### Chunk 27/30
**Article:** Integrative Medicine for Erectile Dysfunction: A Holistic Approach (2024)
**Journal:** Sexual Medicine Society of North America
**Section:** abstract | **Similarity:** 0.654

Abordagem integrativa para disfunção erétil na medicina funcional e longevidade. Medicina integrativa incorpora nutrição, exercício, sono, gerenciamento de estresse e bem-estar mental para promover saúde sexual. Combinar terapias inovadoras como terapia por ondas de choque (GAINSWave), plasma rico em plaquetas (PRP) e Emsella (HIFEM) com abordagem de medicina funcional pode fornecer soluções holísticas e abordar causas subjacentes da disfunção erétil. Disfunção endotelial, síndrome metabólica, diabetes, hipertensão e dislipidemia estão fortemente associadas à DE, refletindo fisiopatologia vascular compartilhada entre aterosclerose peniana e sistêmica. Tratamento combinado deve se tornar estratégia principal, e métodos de tratamento gradualmente se moverem para personalização e precisão.
