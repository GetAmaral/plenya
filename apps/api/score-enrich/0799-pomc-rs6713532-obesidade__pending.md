# ScoreItem: POMC rs6713532 (Obesidade)

**ID:** `019c1a2b-a36f-7aed-b948-9d472c23c6d5`
**FullName:** POMC rs6713532 (Obesidade) (Genética - Metabolismo)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019c1a2b-a36f-7aed-b948-9d472c23c6d5`.**

```json
{
  "score_item_id": "019c1a2b-a36f-7aed-b948-9d472c23c6d5",
...
**ScoreItem:** POMC rs6713532 (Obesidade) (Genética - Metabolismo)

**30 chunks de 14 artigos (avg similarity: 0.619)**
...
entar, avaliação da resposta em 2–4 semanas.
### 5. MC4R e sistema das melanocortinas: fisiologia da saciedade e manejo de carboidratos
- MC4R: receptor chave do sistema das melanocortinas; ativado por MC4 (derivado da POMC) para sinalizar saciedade.
- Polimorfismos reduzem funcionalidade do receptor; o núcleo arqueado do hipotálamo recebe sinal inadequado → fome aumentada, baixa saciedade, comportamento mais compulsivo e maior risco de ganho de peso.
- Hormônios envolvidos: leptina, insulina, GLP-1, PYY, colecistocinina, GIP; informam o hipotálamo sobre status energético.
- Neuropeptídeos anorexigênicos: POMC e CART; CART regulado por anfetamina/cocaína (menção histórica).
- Metanálise (2022, 11 estudos): RS que “termina com 13” associado significativamente à obesidade; dados citados incluem aumento de risco e tendência a pior manejo de carboidratos.
...
**Article:** Psiquiatria Metabólica Funcional Integrativa AULA 17 (2024)
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.618
...
geneticamente predispostos.
   - Interação significativa entre alto risco genético e estilos de vida ruins; orientações genéricas “tenha um estilo de vida saudável” são insuficientes sem personalização por polimorfismos e intervenções alimentares diferenciadas.
* Implicações práticas
   - Mesmo gêmeos univitelinos podem responder de forma diferente a grupos e quantidades de alimentos; reforça que “o que faço com esse é diferente do que faço com aquele”.
### 5. Obesidade, IMC e relações causais com doenças
* Randomização mendeliana por sexo
   - Amostras: 228.466 mulheres e 195.041 homens.
   - Obesidade causa: doença arterial coronariana, acidente vascular cerebral (especialmente isquêmico), DPOC, câncer de pulmão, diabetes tipo 1 e 2, doença hepática gordurosa não alcoólica, hepatopatia crônica, insuficiência renal aguda e crônica.
...
anos e função mitocondrial aplicada ao manejo do peso (aprofundamento)
8. Continuação sobre “outros genes” além de MC4R, PPAR-γ2 e PGC-1α
9. Discussão detalhada de medicações para emagrecimento e mecanismos de combinações farmacológicas (bupropiona/naltrexona, semaglutida, benzodiazepínicos)
10. Quadro completo de “alvos genômicos” e suplementos correlatos; nome/protocolo do suplemento rico em esperidina e suas evidências clínicas
## Conteúdo Coberto
### 1. Princípios de modulação epigenética no manejo do peso
- Modulação de expressão gênica é lenta (anos) e depende de rotina, consistência, adesão e tempo.
- Programação metabólica fetal e primeiros anos de vida são janelas críticas de risco epigenético.
- Quebra do paradigma de “vitimização” genética: genes modulam risco; estilo de vida determina desfechos.
