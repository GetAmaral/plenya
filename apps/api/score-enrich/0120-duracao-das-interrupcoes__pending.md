# ScoreItem: Duração das interrupções

**ID:** `019bf31d-2ef0-7bc5-8cd7-4673f4f13134`
**FullName:** Duração das interrupções (Sono - Atual - Interrupções do sono)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7bc5-8cd7-4673f4f13134`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7bc5-8cd7-4673f4f13134",
...
**ScoreItem:** Duração das interrupções (Sono - Atual - Interrupções do sono)

**30 chunks de 10 artigos (avg similarity: 0.503)**
...
**Article:** Ritmo Circadiano Eixo HPA - Parte XII (2024)
**Journal:** Pos Graduacao MFI
**Section:** conclusion | **Similarity:** 0.484
