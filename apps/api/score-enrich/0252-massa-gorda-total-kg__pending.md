# ScoreItem: Massa gorda total (kg)

**ID:** `019bf31d-2ef0-737e-9274-5a5c90255d77`
**FullName:** Massa gorda total (kg) (Composição corporal - Atual - Medidas objetivas)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-737e-9274-5a5c90255d77`.**

```json
{
  "score_item_id": "019bf31d-2ef0-737e-9274-5a5c90255d77",
...
**ScoreItem:** Massa gorda total (kg) (Composição corporal - Atual - Medidas objetivas)

**30 chunks de 15 artigos (avg similarity: 0.587)**
...
Responsabilidade Individual e Saúde Pública**
    - A responsabilidade primária pelo sobrepeso/obesidade é do indivíduo, que deve ser ajudado sem vitimismo.
    - Melhorar o manejo do sobrepeso/obesidade é questão de saúde pública, podendo reduzir custos e liberar leitos de UTI, frequentemente ocupados por complicações de resistência insulínica.

### 3. Avaliação e Ferramentas no Tratamento
*   **Limitações do IMC**
    - IMC é avaliação pobre: considera apenas peso e altura, sem diferenciar músculo de gordura.
    - Subnotifica casos: pessoas com peso normal podem ter excesso de gordura e pouca massa muscular (obesidade sarcopênica), estando metabolicamente doentes.
    - Apenas 12% dos adultos americanos são metabolicamente saudáveis; menos de um terço das pessoas com peso normal se enquadram nessa categoria.
...
teria que ser só gordura, para que você não faça uma perda de outra coisa e ganhe gordura. Aí é lipossubstituição. É o que ninguém quer. Piora a saúde.
> Speaker 1: Saiu de um consultório médico lá, sem orientação, só com a caneta, vai perder músculo. É ponto. É sabido.
### Filosofia de Tratamento
> Speaker 1: Perceba que por mais que a sobrepeso, a obesidade sejam doenças crônicas, sempre devemos buscar uma forma dos indivíduos, dos pacientes, não necessitarem das medicações.
...
**Journal:** Pos Graduacao MFI
**Section:** introduction | **Similarity:** 0.574
...
ndrial no músculo, ativando enzimas do metabolismo energético (Citrato Sintase, beta-oxidação) e melhorando a capacidade do corpo de queimar gordura.
*   **Identificação de Candidatos para Terapia:** A terapia com GH pode ser mais útil em um subgrupo de obesos com perfil de alto risco cardiovascular: aqueles com **GH baixo e IGF-1 baixo**.
*   **Obesidade como Condição Celular:** A obesidade deve ser vista como uma disfunção celular e enzimática (baixa atividade de enzimas oxidativas, disfunção mitocondrial), e não apenas como um desequilíbrio calórico. O exercício de alta intensity pode ajudar a reverter esse perfil enzimático desfavorável.
## ❓ Perguntas
- [Inserir Pergunta/Confusão]
## 📚 Tarefas
- [ ] 1. Estudar a fisiologia endócrina básica, começando pela regulação do GH, para compreender os conceitos apresentados.
- [ ] 2. Evitar o consumo de refeições ricas em carboidratos perto da hora de dormir para não prejudicar a produção noturna de GH.
