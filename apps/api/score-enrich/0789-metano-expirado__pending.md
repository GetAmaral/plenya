# ScoreItem: Metano expirado

**ID:** `019bf31d-2ef0-7e0f-b23f-109557d6d51d`
**FullName:** Metano expirado (Exames - Imagem)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7e0f-b23f-109557d6d51d`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7e0f-b23f-109557d6d51d",
...
**ScoreItem:** Metano expirado (Exames - Imagem)

**30 chunks de 10 artigos (avg similarity: 0.696)**
...
**Section:** abstract | **Similarity:** 0.839
...
**Section:** abstract | **Similarity:** 0.757
...
**Section:** results | **Similarity:** 0.752
...
**Journal:** Digestive Diseases and Sciences
**Section:** discussion | **Similarity:** 0.742
...
**Article:** Hydrogen Sulfide and Methane on Breath Test Correlate with Human Small Intestinal Hydrogen Sulfide Producers and Methanogens (2025)
**Journal:** Digestive Diseases and Sciences
**Section:** discussion | **Similarity:** 0.720
...
**Section:** abstract | **Similarity:** 0.715
...
**Article:** Hydrogen Sulfide and Methane on Breath Test Correlate with Human Small Intestinal Hydrogen Sulfide Producers and Methanogens (2025)
**Journal:** Digestive Diseases and Sciences
**Section:** conclusion | **Similarity:** 0.654
