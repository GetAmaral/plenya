# ScoreItem: Cádmio urina 24h

**ID:** `019bf31d-2ef0-7da2-a52b-f0b8b1294476`
**FullName:** Cádmio urina 24h (Exames - Laboratoriais)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7da2-a52b-f0b8b1294476`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7da2-a52b-f0b8b1294476",
...
**ScoreItem:** Cádmio urina 24h (Exames - Laboratoriais)

**30 chunks de 18 artigos (avg similarity: 0.538)**
...
**Journal:** Pos Graduacao MFI
**Section:** methods | **Similarity:** 0.523
