# ScoreItem: Situação familiar/amigos de exercícios atual

**ID:** `c77cedd3-2800-7f9c-9bf6-5c053962ca97`
**FullName:** Situação familiar/amigos de exercícios atual (Movimento e atividade física - Atual)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7f9c-9bf6-5c053962ca97`.**

```json
{
  "score_item_id": "c77cedd3-2800-7f9c-9bf6-5c053962ca97",
...
**ScoreItem:** Situação familiar/amigos de exercícios atual (Movimento e atividade física - Atual)

**30 chunks de 17 artigos (avg similarity: 0.599)**
...
**Section:** introduction | **Similarity:** 0.628
