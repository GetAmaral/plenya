# ScoreItem: Índice MME (kg/m²)

**ID:** `019bf31d-2ef0-7964-ac29-63bf9c224bef`
**FullName:** Índice MME (kg/m²) (Composição corporal - Atual - Medidas objetivas)
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `019bf31d-2ef0-7964-ac29-63bf9c224bef`.**

```json
{
  "score_item_id": "019bf31d-2ef0-7964-ac29-63bf9c224bef",
...
**ScoreItem:** Índice MME (kg/m²) (Composição corporal - Atual - Medidas objetivas)

**30 chunks de 11 artigos (avg similarity: 0.610)**
...
separadamente é ineficaz. O conceito evolui para revelar a dinâmica própria: o adipócito branco intensifica a inflamação, enquanto o músculo insuficiente perde a capacidade regulatória anti-inflamatória. No ápice, transforma‑se em orientação prática robusta: metas clínicas devem focar recomposição corporal (perder gordura e ganhar massa magra) para restaurar o controle inflamatório. Essa estratégia se alinha aos programas de resolução ativa e ao desmonte da meta‑inflamação, mostrando que a massa muscular é instrumento terapêutico sistêmico.
**Trilha de evidências:**
> “Obesidade sarcopênica... esse obeso, além de pouca massa muscular... ainda tem uma quantidade absurda de tecido adiposo branco... Não tem como conter a inflamação... 40% de aumento de mortalidade.”
>
> “As mioquinas exercem um papel regulador... um papel regulador anti-inflamatório...”
>
...
um papel regulador anti-inflamatório... estratégias para ganho de massa muscular... hoje está longe de ser só estética.”
>
> “obeso sarcopênico... 40% maior mortalidade.”
>
> “Low-grade inflammation... prejudica a muscle protein synthesis...”
**Rastro de desenvolvimento:**
- Mioquinas como Reguladores Anti-inflamatórios Centrais
- Sarcopenia como Fenótipo Inflamatório Precoce
- Obesidade Sarcopênica como Estado Inflamatório Incontenível
...
**Journal:** Pos Graduacao MFI
**Section:** introduction | **Similarity:** 0.603
...
odulam metabolismo e protegem contra cronicidade.
**Significado e evolução:**
O conceito inicia derrubando a crença de que hipertrofia é estética. Desenvolve‑se ao posicionar mioquinas como mediadores centrais na contenção inflamatória, conectando-se diretamente com resolução ativa e meta‑inflamação. Em sua expressão mais ampla, torna‑se um princípio terapêutico: “construir músculo” vira ferramenta para encerrar loops inflamatórios (cérebro‑intestino‑HPA), reduzir resistência insulínica e mitigar risco em câncer e envelhecimento. Relaciona‑se intimamente com sarcopenia e obesidade sarcopênica, oferecendo o mecanismo pelo qual a recomposição corporal produz ganhos sistêmicos.
**Trilha de evidências:**
> “As mioquinas exercem um papel regulador... um papel regulador anti-inflamatório... estratégias para ganho de massa muscular... hoje está longe de ser só estética.”
>
> “obeso sarcopênico...
...
- Sarcopenia como Fenótipo Inflamatório Precoce
---
### Mioquinas como Eixo Endócrino Anti-inflamatório do Músculo
**Categoria:** Princípio fisiológico funcional
**Definição central:**
Mioquinas são sinais endócrinos derivados do músculo esquelético que exercem regulação anti-inflamatória sistêmica. Elas transformam o músculo em órgão imunometabólico: ao aumentar massa e qualidade muscular, ampliam‑se sinais que contêm inflamação, modulam metabolismo e protegem contra cronicidade.
**Significado e evolução:**
O conceito inicia derrubando a crença de que hipertrofia é estética.
...
ácidos essenciais pós-exercício
  - Estratégia intermediária: emagrecimento com preservação muscular; suportam reparo e gliconeogênese sem grande elevação de insulina.
### 9. Composição Corporal, Sarcopenia e Metabolismo Basal
- Obesidade sarcopênica (“falsa magra”)
  - Baixa massa muscular com excesso de gordura; em déficit energético, cuidado para não perder mais massa.
- Massa muscular e gasto energético
  - Eleva metabolismo basal e custo energético do exercício; maior demanda de sangue/oxigênio para fibras.
### 10. Carga Externa vs. Carga Interna e Monitorização
- Carga externa
  - Séries, peso, intervalo, velocidade; aumentar intensidade: mais carga, menos pausa, execução mais rápida.
- Carga interna
  - Resposta do organismo: HRV, termografia e metabolismo bioquímico energético (padrão ouro próximo).
  - Indivíduos com mesma carga externa geram cargas internas distintas; individualização é essencial.
...
... vai para a via da quinurenina...”
>
> “N-metil-D-aspartato superativado.”
**Rastro de desenvolvimento:**
- Circuito Inflamação–HPA–Cérebro–Intestino Autoalimentado
---
### Sarcopenia como Fenótipo Inflamatório Precoce e Nó Causal Metabólico
**Categoria:** Modelo operacional
**Definição central:**
Sarcopenia é redefinida como um fenótipo de inflamação crônica de baixo grau que começa cedo, reduz a síntese proteica muscular e aumenta o catabolismo, em interação bidirecional com adiposidade e resistência insulínica. Não é apenas um marcador de idade, mas um nó causal que modula risco sistêmico.
**Significado e evolução:**
O conceito se inicia rompendo o estereótipo de “doença do idoso”. Evolui ao demonstrar que o músculo é vítima e agente: a inflamação prejudica o anabolismo e, em contrapartida, a perda de massa remove um tampão anti-inflamatório (mioquinas), piorando o cenário metabólico.
...
edandtheshortphysicalperformancebat-tery(SPPB).Techniciansgenerallydecidewhetherthetestcanbecompletedandthecompletiontime,whichcreatesacertainbias.Third,osteoporosisandsarcopeniaarechronicdiseases,andnotallindividualsexhibitthesameratesofmuscleandboneloss.Therefore,corre-spondingindicatorstotrackprogressionovertimeortheresponsetointerventionsareimportantandneces-sary.Toovercometheshortageofcurrentlyavailabletechniquestoevaluatemuscleandbone,apoolofserumbiomarkerswasrecentlydevelopedbasedonthemo-lecularbiologicalmechanismsoftheirinvolvementinthepathogenesisofsarcopeniaandosteoporosis,suchasendocrinesystem,growthfactors,andmuscleproteinturnover.Biomarkers,whichtheoreticallyaffectthesemechanisms,maypredictorreflectthestateofbonesandmuscles[5,6].However,whetherthesebiomarkerstrulyreflectthestateofbonesandmuscleswasnotveri-fied.Toexploretherelationshipbetweenbiomarkersandbonesandmuscles,weidentifiedbiomarkersofosteoporosisandsarcopeniaaccordingtodifferentpathophysiologicalmechanisms.(1)Myok
