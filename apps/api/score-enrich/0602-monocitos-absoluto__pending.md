# ScoreItem: Monócitos (absoluto)

**ID:** `c77cedd3-2800-7f4c-a11e-615de3ab8a72`
**FullName:** Monócitos (absoluto) (Exames - Laboratoriais)
**Unit:** k/µL
...
**O JSON deve obrigatoriamente conter o campo `score_item_id` com o valor `c77cedd3-2800-7f4c-a11e-615de3ab8a72`.**

```json
{
  "score_item_id": "c77cedd3-2800-7f4c-a11e-615de3ab8a72",
...
**ScoreItem:** Monócitos (absoluto) (Exames - Laboratoriais)
**Unidade:** k/µL

**30 chunks de 16 artigos (avg similarity: 0.607)**
