...
excerpt: "Em vinte anos de hospital, vi a mesma cena se repetir: o exame 'normal' até o dia em que não é mais. Quatro doenças matam a maioria dos adultos depois dos 40 — e nenhuma chega de surpresa para quem sabe ler."
date: 2026-04-26
...
Ricardo não foi negligente. Ele foi vítima de um modelo de check-up desenhado para encontrar doença instalada, não risco em formação. E o que matava por dentro — silencioso, durante mais de dez anos — eram quatro processos avançando ao mesmo tempo. Aprendi nessas duas décadas dentro do hospital que esses quatro andam sempre juntos.
