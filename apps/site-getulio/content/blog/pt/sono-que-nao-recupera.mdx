...
Vi paciente hipertenso e fadigado demais em que o diagnóstico real, no fim, era apneia obstrutiva do sono. Estimativas conservadoras: **70 a 80% dos casos não são detectados**. O perfil clássico — homem obeso, ronco escandaloso, sonolência diurna — pega só uma parte do iceberg.
...
- **Álcool à noite** — facilita o início do sono, mas suprime drasticamente N3 e REM na primeira metade da noite. Duas taças de vinho ao jantar custam sono profundo. Essa é, hoje, a primeira pergunta que faço quando alguém chega com queixa de sono que não recupera.
