...
excerpt: "A maioria treina invertido: muito esforço médio, pouca base aeróbica, força mal-orientada. A receita que a literatura sustenta é simples: 80% em Zona 2, 20% em alta intensidade, força duas a três vezes por semana. Faz diferença em quem você será aos 75."
date: 2026-04-26
updated: 2026-05-18
...
Antes da receita, vale a pergunta: você sabe que precisa dela? Se ainda acha que o seu treino atual está funcionando, o lugar certo de começar é em [Treinar muito e envelhecer errado](/artigos/treinar-muito-e-envelhecer-errado), que descreve os marcadores que denunciam o treino fora do alvo. Aqui o trabalho é prescritivo. Diagnóstico antes; receita agora.

O Felipe tem 46 anos. Advogado, corre 8 km cinco vezes por semana há quinze anos. Veio ao consultório semana passada. Mesma rota, mesmo ritmo, *ritmo de corrida confortável*, ele diz. Frequência cardíaca durante a corrida: 158 a 172 bpm. Para a idade dele, isso é zona 3-4, o limbo do "confortavelmente desconfortável". A dieta dele é boa, o peso é estável, o exame "normal".

Pedi um teste cardiopulmonar (TCPM) com lactato e composição corporal. Os números confirmaram o que eu suspeitava ao ler o relato: VO₂máx baixo para idade, limiar de lactato cruzado em quase todo treino, massa magra na faixa baixa, força de preensão abaixo do esperado. *Doutor, eu treino mais que todo mundo que conheço. Por que meus números são piores?*

A história do Felipe é o paradoxo que mais me intrigou ao longo dos anos: paciente que treina muito, e treina o que importa pouco. Volume sem direção é ruído fisiológico. E cobra preço. A receita é específica.
...
Não é uma questão de treinar mais. É de treinar a fisiologia certa, e a fisiologia certa muda completamente depois dos 40.
...
![Distribuição polarizada do treino para longevidade em adultos >40: 35% força progressiva (3 sessões/sem, padrões compostos com sobrecarga), 50% Zona 2 aeróbica de base (3-4 h/sem, 60-70% FCmáx), 15% VO₂máx/HIIT (1 sessão/sem, 4×4 min a 90% FCmáx). EVITAR Zona 3 ("junk miles", esforço médio sem retorno). Cada modalidade com função fisiológica distinta.](/images/blog/treinar-para-envelhecer-bem-zona-2-e-forca/figura-1.webp)
...
Três a quatro horas por semana em Zona 2, distribuídas em 45-60 minutos por sessão, é a dose habitual que prescrevo. Pode ser caminhada inclinada, bicicleta, esteira, remo. O importante é a **constância da intensidade**, não a modalidade.
...
Por que VO₂máx importa? Penso que esse é talvez o dado isolado mais importante que vi em toda minha prática clínica. O estudo de Kyle Mandsager e colegas, publicado no *JAMA Network Open* em 2018, analisou 122.007 adultos submetidos a teste de esforço na Cleveland Clinic. Os pacientes no quartil superior de capacidade cardiorrespiratória tiveram **mortalidade aproximadamente cinco vezes menor** que os no quartil inferior, ao longo do seguimento. E o estudo não mostrou teto: *quanto mais alto o VO₂máx, menor a mortalidade*, sem ponto de saturação.

Esse achado mudou a conversa, e mudou a minha conversa no consultório. VO₂máx não é variável de atleta, é variável de mortalidade. E ele responde rapidamente ao estímulo certo: um bloco de seis a oito semanas de intervalos pode aumentar o VO₂máx em 5-15%.
...
- Após os 50, integrar trabalho de **explosão (potência)**, como saltos curtos, arremessos e kettlebell, porque a perda de fibras tipo II (rápidas) é mais severa que a perda de fibras tipo I (lentas).
...
A curva dose-resposta é íngreme no começo. Sair do sedentarismo é o passo de maior retorno. Esse é, na minha opinião, o dado que mais deveria estar na boca de todo médico generalista. Depois disso, a estrutura (Zona 2 + alta intensidade + força) refina o resultado.
...
- **Recuperação da frequência cardíaca**: quanto cai um minuto após interromper esforço intenso. Acima de 18 bpm é sinal de boa função autonômica.
...
Em painel mais completo: TCPM com gases para VO₂máx e limiar de lactato, DEXA para composição corporal, dinamômetro para preensão. São o painel que dá ao treino números reais. Esse mesmo painel, lido na direção oposta, é o que aparece em [Treinar muito e envelhecer errado](/artigos/treinar-muito-e-envelhecer-errado) como sinal de que o estímulo atual está fora do alvo.

## A leitura que faço no consultório

No consultório, o educador físico que entra junto comigo não é "personal trainer". Entra no painel inicial junto com médico e nutricionista, com acesso aos exames, à composição corporal e à leitura clínica. O plano é desenhado em três faixas (Zona 2, intensa, força), com progressão escrita e reavaliação trimestral. Felipe, do começo, hoje corre menos: três sessões na semana, sendo duas em Zona 2 controlada por monitor cardíaco e uma com intervalos. Adicionou três sessões de força. Em oito meses, VO₂máx subiu de 38 para 47, ganhou 3,2 kg de massa magra, força de preensão para 44 kg. *Treino menos. Sou outro corredor.*

Vi muito paciente como Felipe. Quem treina sem leitura pode ficar quinze anos correndo errado. A receita é simples: Zona 2, alta intensidade, força. As três coisas, na proporção certa, e com paciência para os anos.
