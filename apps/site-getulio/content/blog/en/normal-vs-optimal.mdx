...
The result, as I have argued for two decades: “normal” spans a wide window that contains people on a trajectory toward disease, healthy people, and people in optimal condition all at once. For screening established disease, that works. For building longevity, it does not.
