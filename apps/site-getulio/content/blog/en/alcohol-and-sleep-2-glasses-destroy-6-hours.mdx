...
Moralism does not change behavior — and the literature is consistent enough for some practical positions, without requiring full abstinence if that is not the goal:
