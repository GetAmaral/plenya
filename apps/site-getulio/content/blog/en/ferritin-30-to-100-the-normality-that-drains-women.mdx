...
excerpt: "In twenty years inside the hospital, I watched too many women carry a years-long fatigue with a CBC the lab called normal. The lab clears ferritin starting at 15. I learned to call deficient anything below 50 in a menstruating woman."
date: 2026-04-26
...
I saw Marcela last month. She is 38. A lawyer, two small children, regular and abundant menstrual cycle. For nearly two years she had been feeling a fatigue she herself described to me as *the kind of fatigue coffee doesn't fix*. Hair falling in the shower. Shortness of breath climbing two flights of stairs. A treadmill run that used to deliver 7 km, now 4 km and feeling like triple.

She had done a CBC. Hemoglobin 13.1 g/dL — within range. Ferritin 38 ng/mL — the lab stamped it *reference value: 13 to 150*. *All normal*, she heard from two different physicians before me. *It's the routine, it's stress, it's motherhood.*
...
The recent literature has worked to quantify this — and it confirms what I had been seeing in my clinic for years.
...
For an adult menstruating woman, or for any symptomatic adult, the useful clinical reading of ferritin I use is not the one on the label:
...
A technical caveat is worth noting: ferritin is an acute-phase protein. In any inflammatory state — infection, autoimmune disease, obesity, last week's flu — it rises falsely. If the patient has ferritin 70 but elevated hs-CRP, deficiency may be masked. I always read ferritin alongside complete CBC, transferrin saturation, total iron-binding capacity, and CRP.

## How to replace (and what not to do)

Oral replacement is the first line. Classical ferrous sulfate (40 to 65 mg elemental iron) works, but has a high rate of gastrointestinal intolerance — nausea, constipation, metallic taste. Patients I see who gave up on iron usually gave up because of that, not for lack of need.

What I prescribe in practice:
...
In some cases — malabsorption, persistent oral intolerance, chronic bleeding — **intravenous replacement** is indicated, today done in an outpatient protocol with ferric carboxymaltose or iron derisomaltose, in one or two infusions. I have seen it change the life of women with disabling fatigue and very low ferritin within three to six weeks.

The cause needs to be investigated in parallel. If ferritin keeps falling despite replacement, or if the patient is a man or a postmenopausal woman, **the first question I ask is where the bleeding is** — usually menstrual in women of reproductive age (menorrhagia), gastrointestinal tract in others (ulcer, diverticulum, neoplastic lesion). Replacing without investigating is treating a symptom and missing the underlying diagnosis. I learned that the hard way years ago, with a patient I was treating only for ferritin and who had a colon lesion no one had asked about.

## What changed for Marcela

Initial ferritin 38, transferrin saturation 14%, hemoglobin 13.1, hs-CRP 0.4 (no inflammation). I started iron bisglycinate 50 mg every other day, fasting, with vitamin C. Referral to gynecology to assess menorrhagia (which ended up indicating a hormonal IUD, which reduced flow to almost nothing).
...
## What I learned reading ferritin

Iron deficiency in a menstruating woman is not solved just by replacing iron. It is solved by also adjusting what is taking iron out of the system — and by reading ferritin alongside the menstrual cycle, body composition, training, sleep, hair loss. None of these things alone tells the whole story.
