...
export const metadata: Metadata = {
  title: 'Onde atendo',
  description:
    'Atendimento clínico na Plenya (medicina funcional integrativa) e na Nefroclínica Londrina (nefrologia clínica). Responsabilidade técnica na DaVita Intra Hospitalar de Londrina.',
};
    ...
    <article>
      <header className="editorial-container pt-16 md:pt-24 pb-12">
        ...
        <h1 className="heading-display text-[clamp(2.2rem,5vw,3.8rem)] max-w-3xl">
          Três frentes, a mesma medicina.
        </h1>
        <p className="prose-body mt-8 max-w-2xl">
          Atendo em duas clínicas em Londrina e respondo tecnicamente pela hemodiálise
          hospitalar. As três frentes são a mesma medicina aplicada em momentos diferentes
          do tempo da pessoa — antecipar, acompanhar, tratar.
        </p>
      </header>
        ...
        {clinicas.map((c) => (
          ...
          >
            ...
            <div className="space-y-5">
              <h2 className="heading-section text-2xl md:text-3xl">{c.name}</h2>
