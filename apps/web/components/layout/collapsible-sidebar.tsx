...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      // Mesmos papéis do RequireClinician no backend: sem isto o menu ofereceria uma tela que a
      // API recusa. /plano é um trampolim que resolve o paciente selecionado e redireciona.
      {
        name: "Plano de Devolutiva",
        href: "/plano",
        icon: Presentation,
        staffOnly: true,
        requiredRoles: [
      ...
      {
        name: "Exames a revisar",
        href: "/lab-results/revisar",
        icon: Microscope,
        staffOnly: true,
        requiredRoles: [
          "admin",
      ...
      {
        name: "Documentos",
        href: "/issued-documents",
        icon: FileSignature,
        staffOnly: true,
      },
      {
        name: "Views de Resultados",
        href: "/lab-result-views",
        icon: LayoutList,
        staffOnly: true,
      },
      {
    ...
    items: [
      {
        ...
        icon: ClipboardList,
        staffOnly: true,
        requiredRoles: ["admin", "secretary", "manager"],
      },
      {
        name: "Calendário",
        href: "/calendario",
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Testes de Fitness",
        href: "/training/fitness-tests",
        icon: Target,
        staffOnly: true,
      },
      {
        name: "Avaliação Postural",
        href: "/training/posture",
        icon: UserIcon,
        staffOnly: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Templates de Anamnese",
        href: "/anamnesis-templates",
        icon: FileCheck,
        staffOnly: true,
      },
      {
        name: "Template de Pedido de Exame",
        href: "/lab-request-templates",
        icon: LayoutTemplate,
        staffOnly: true,
      },
      {
      ...
      {
        name: "Templates Continuum",
        href: "/configuracoes/continuum-templates",
        icon: Workflow,
        staffOnly: true,
        requiredRoles: ["admin", "manager"],
      },
      {
        name: "Templates de Box",
        href: "/configuracoes/box-templates",
        icon: Package,
        staffOnly: true,
        requiredRoles: ["admin", "manager"],
      },
      ...
      },
      {
        ...
        icon: Bot,
        staffOnly: true,
        requiredRoles: ["admin", "secretary", "manager", "doctor"],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Definições de Medicamentos",
        href: "/admin/medication-definitions",
        icon: Pill,
        adminOnly: true,
      },
      {
        name: "Catálogo Magistral",
        href: "/admin/magistral-components",
        icon: FlaskConical,
        adminOnly: true,
      },
      {
        name: "Fórmulas-base",
        href: "/admin/formulas-base",
        icon: BookMarked,
        adminOnly: true,
      },
      {
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="flex h-16 items-center border-b border-border px-4 gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="font-heading text-xl leading-none text-petrol">
                  Plenya
                </h1>
                <p className="label-upper mt-1 text-muted-foreground">
                  Prontuário
                </p>
              </div>
              <button
      ...
      {groups.map((group) => {
        const items = group.items.filter((item) => {
          ...
          if (
            item.requiredRoles &&
            isHydrated &&
            !item.requiredRoles.some((r) => isGranted(user, r))
          )
            return false;
          if (
            searchQuery &&
...
function NavItemRow({
  ...
  const labReview = useLabReviewCount({
    enabled: item.badgeKey === "lab-review",
  });
  const badgeValue =
  ...
  return (
    <Link href={item.href}>
      <div
        ...
        title={
          collapsed
            ? `${item.name}${showBadge ? ` (${badgeValue} ${badgeNoun})` : ""}`
            : undefined
        }
      >
