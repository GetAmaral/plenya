...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Catálogo Magistral", href: "/admin/magistral-components", icon: FlaskConical, adminOnly: true },
      { name: "Fórmulas-base", href: "/admin/formulas-base", icon: BookMarked, adminOnly: true },
