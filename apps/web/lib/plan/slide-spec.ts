 ...
 */
export type BlockId = 'header' | 'cards' | 'table' | 'rulers' | 'summary' | 'takeaway' | 'steps';
...
export interface SlideSpec {
   ...
   */
  ceilings?: Partial<Record<'rulers' | 'rows' | 'cols' | 'cards' | 'lines' | 'groups', number>>;
...
export const SLIDE_SPEC: Record<DeckSlideKind, SlideSpec> = {
  ...
  'two-cards': {
    ...
    blocks: ['header', 'cards'],
    ceilings: { cards: 2 },
    hint: 'Sempre dois: é o contraste entre o caminho descartado e o que vale que ensina.',
  },
  'plan-step': {
    label: 'Uma conduta',
