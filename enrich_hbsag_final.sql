...
INSERT INTO articles (id, title, authors, journal, publish_date, doi, pm_id, article_type, url, key_findings, created_at, updated_at)
VALUES
(
    gen_random_uuid(),
...
INSERT INTO article_score_items (score_item_id, article_id, created_at)
SELECT
