...
**A — Alimentação, Atividade Física e Suplementação.** Os três motores do estilo de vida que nenhuma medicação substitui. Capítulo 7.

**G — Gestão Metabólica.** Hormônios, genômica, farmacologia guiada por biomarcadores — o painel de controle que transforma dados em decisão clínica. Capítulo 8.

**I — Integração Corpo-Mente.** O eixo entre psicologia, sistema imune e inflamação — o pilar que a medicina fragmentada ignora e que, quando não é tratado, sabota todos os outros. Capítulo 9.
