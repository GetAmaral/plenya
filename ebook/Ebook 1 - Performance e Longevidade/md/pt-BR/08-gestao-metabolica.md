...
Importa. Porque testosterona baixa não é um número isolado — é um marcador que se correlaciona com mortalidade, risco cardiovascular, perda de massa muscular, declínio cognitivo e qualidade de vida. Uma meta-análise publicada em 2024 na *Annals of Internal Medicine*, reunindo dados de mais de 24.000 homens acompanhados por pelo menos cinco anos, mostrou que homens com níveis de testosterona total abaixo de 7,4 nmol/L (cerca de 213 ng/dL) tinham risco significativamente maior de morte por qualquer causa. Abaixo de 5,3 nmol/L (cerca de 153 ng/dL), o risco se estendia especificamente a eventos cardiovasculares fatais. Não era apenas sintoma — era trajetória.
...
### O Painel Hormonal: Mais do que Testosterona
...
**Estradiol.** Hormônio geralmente pensado como "feminino", mas homens precisam dele. Estradiol muito baixo em homens está associado a perda de massa óssea, piora de humor e disfunção sexual; muito alto, a ginecomastia e retenção hídrica. A faixa ótima para homens fica entre 20 e 40 pg/mL. A maioria dos médicos não pede. Quando se prescreve testosterona sem monitorar estradiol, o resultado é uma otimização que pode virar problema.
...
### O Dilema da Reposição Hormonal: Quando Tratar, Quando Não
...
Mas o TRAVERSE também mostrou que a reposição aumentou ligeiramente o risco de fibrilação atrial (5,2% vs. 3,3%) e lesão renal aguda. E estudos anteriores já haviam demonstrado aumento de hematócrito — o que exige monitoramento regular e, em alguns casos, flebotomia. Não é um tratamento cosmético. É uma intervenção médica que exige critério na indicação e acompanhamento próximo.
...
**Quando não considero reposição?** Quando o paciente está na faixa subótima mas sem sintomas, ou quando os sintomas podem ser explicados por outros fatores. No caso de Paulo, a primeira intervenção não foi prescrição de testosterona. Foi uma reestruturação do sono — ele dormia em média seis horas por noite, com microdespertares frequentes —, otimização da vitamina D (estava em 24 ng/mL, subiu para 52 em quatro meses), e um ajuste no treino de força para incluir movimentos compostos com carga progressiva. Em quatro meses, a testosterona total subiu de 310 para 420 ng/dL e a livre de 4,8 para 8,1 pg/mL. Sem medicação. Às vezes, otimizar o terreno resolve antes de precisar mexer no hormônio.

A mesma lógica, com diferenças importantes de contexto, se aplica à reposição hormonal em mulheres na transição menopausal e pós-menopausa — tema que merece um espaço próprio e que não cabe neste capítulo.

---

### Farmacologia de Precisão: Medicamentos como Ferramentas de Longevidade

A segunda grande frente da gestão metabólica é o uso estratégico de medicamentos — não como último recurso quando tudo falha, mas como ferramentas que, guiadas por biomarcadores, podem mudar a trajetória de risco quando o estilo de vida sozinho não basta.

**Estatinas: guiadas por CAC e ApoB, não apenas por LDL.** Como vimos nos Capítulos 4 e 5, o ApoB é um marcador superior ao LDL para estimar risco aterosclerótico real, e o CAC score revela a presença de placa quando ainda é invisível aos cálculos convencionais. A combinação dessas duas informações muda a decisão sobre estatina. Um paciente com LDL "limítrofe" de 135 mg/dL mas CAC de 0 e ApoB de 72 provavelmente não precisa de estatina neste momento — o risco está baixo. Outro paciente com LDL igual, CAC de 220 e ApoB de 110 está num cenário completamente diferente: a placa já existe, o ApoB mostra carga aterogênica real, e a indicação de tratamento agressivo é clara. Como vimos no Capítulo 7, o plano de Marcos incluiu intensificação de estatina e adição de ezetimiba não por causa do número isolado de LDL, mas pela combinação: CAC 412, ApoB 82 em uso prévio de estatina em dose baixa, e a necessidade de derrubar o ApoB para 60 ou menos.
...
**Inibidores de SGLT2: além do diabetes.** Originalmente desenvolvidos como antidiabéticos, os inibidores de SGLT2 (empagliflozina, dapagliflozina) se revelaram muito mais do que medicamentos para glicose. Ensaios como EMPA-REG, DAPA-HF, DAPA-CKD, EMPA-KIDNEY e EMPEROR demonstraram redução consistente em mortalidade cardiovascular, hospitalização por insuficiência cardíaca e progressão de doença renal — em pacientes com e sem diabetes. Em 2024, uma revisão no *Nature Reviews Nephrology* consolidou o papel dessa classe como terapia protetora cardiorrenal ampla. Os mecanismos vão muito além da glicose: redução de pré-carga, melhora da função endotelial, efeito anti-inflamatório, mudança no metabolismo cardíaco para uso preferencial de corpos cetônicos. Para pacientes com insuficiência cardíaca, doença renal crônica, ou alto risco cardiovascular com sinais de disfunção metabólica, os inibidores de SGLT2 são hoje ferramentas de primeira linha — independentemente do status diabético.

**Agonistas GLP-1: não é só sobre peso.** Semaglutida e tirzepatida dominaram o noticiário nos últimos anos por seu efeito sobre obesidade. Mas o impacto biológico dessa classe é mais amplo. Eles reduzem inflamação sistêmica, melhoram sensibilidade insulínica, diminuem esteatose hepática, reduzem risco cardiovascular em pacientes com diabetes ou obesidade (SELECT, LEADER, SUSTAIN-6), e há sinais emergentes sobre efeitos neuroprotetores. Em pacientes com síndrome metabólica refratária, obesidade com comorbidades, ou dificuldade persistente de perda de peso apesar de intervenção estruturada de estilo de vida, podem ser ferramentas decisivas. Não são, e não devem ser, substitutos para alimentação, exercício e sono — são catalisadores em contextos específicos. O uso *off-label* em pessoas sem indicação clara, apenas para perder alguns quilos, é um fenômeno que a medicina ainda está aprendendo a lidar, e a evidência de longo prazo nesses contextos ainda está em construção.
...
### Exposições Ocultas — O Painel Tóxico Que Ninguém Pede
...
**Alumínio** tem fontes menos reconhecidas — antitranspirantes em contato diário com a pele axilar, utensílios de cozinha de alumínio em alimentos ácidos (molho de tomate, vinagre), água de torneira em municípios que usam sulfato de alumínio no tratamento. Acumula-se em tecido cerebral e ósseo; em pacientes com doença renal crônica avançada a vigilância é rotineira, mas em população geral raramente é investigado.

**Selênio e manganês** fazem o caminho oposto: deficiência é mais comum do que excesso no Brasil. Selênio baixo compromete função tireoidiana (converte T4 em T3) e antioxidação (glutationa peroxidase); manganês baixo afeta função mitocondrial. Dosar quando há tireoidite autoimune sem resposta, fadiga crônica resistente a correção de ferro e B12, ou alimentação muito restritiva.
...
**APOE4 e risco neurodegenerativo.** O gene APOE tem três variantes principais — ε2, ε3, ε4. Cada pessoa carrega duas cópias, uma de cada pai. Portadores de uma cópia de ε4 têm risco aumentado para doença de Alzheimer tardio; homozigotos (duas cópias de ε4), cerca de 2 a 3% da população, têm risco tão elevado que um estudo publicado em 2024 na *Nature Medicine* por Fortea e colaboradores propôs classificar o APOE4 homozigoto como uma forma genética distinta de Alzheimer — praticamente todos os portadores desenvolvem marcadores biológicos da doença aos 65 anos. A notícia difícil é essa. A boa notícia é que intervenções de estilo de vida parecem ter efeito maior em portadores de APOE4 do que em não portadores. Uma meta-análise de três ensaios clínicos (FINGER, MAPT, J-MINT), publicada em 2024 em *Alzheimer's & Dementia*, mostrou que intervenções multidomínio (exercício físico, dieta, treino cognitivo, controle de fatores de risco vascular) produziram benefício cognitivo significativamente maior em portadores de ε4. Estudos observacionais sugerem redução de risco de 30 a 45% mesmo em portadores quando há aderência a múltiplos pilares de estilo de vida saudável. APOE4 carrega a arma. O estilo de vida puxa — ou não puxa — o gatilho. Saber o status APOE não é para gerar ansiedade; é para priorizar. Um portador de ε4 com apneia do sono não tratada, sedentarismo e dieta pobre está em território de alto risco. O mesmo portador com sono consolidado, exercício regular e nutrição estruturada pode não desenvolver a doença.
...
*CYP1A2 (rs762551) — cafeína.* Metabolizadores lentos (genótipo CC) têm eliminação lenta da cafeína; cada café da tarde vira um café da meia-noite metabolicamente falando, com impacto no sono, na pressão arterial e no risco cardiovascular. Metabolizadores rápidos (AA) toleram doses maiores sem prejuízo. Saber o genótipo muda a orientação do corte de cafeína — alguns precisam parar às 12h, outros toleram café até as 16h sem comprometimento do sono.
...
### A Lógica Iterativa: Testar, Intervir, Retestar, Ajustar

Se há uma ideia central neste capítulo, é esta: gestão metabólica não é receita pronta. É processo.

O paciente chega. Eu pergunto o que ele quer, o que o preocupa, o que ele já tentou. Peço o painel. O painel volta. Leio os números em conjunto, não isoladamente. Identifico os padrões — não apenas o que está fora de faixa, mas onde cada marcador está em relação à faixa ótima para longevidade. Converso com o paciente sobre o que encontrei, o que significa, e quais são as opções. Construímos um plano.

O plano envolve os pilares que já discutimos: alimentação, exercício, suplementação (Capítulo 7). E, quando necessário, ele envolve os elementos que discutimos aqui: otimização hormonal, farmacologia de precisão, intervenções guiadas por genética. Mas o plano não é estático. É uma hipótese.
...
- Hormônios são sinais bioquímicos que coordenam o corpo inteiro. Testosterona baixa em homens, TSH isolado, cortisol crônico e IGF-1 em U invertido são marcadores que o check-up convencional geralmente ignora ou interpreta mal.

- Reposição hormonal não é elixir da juventude nem vilã cardiovascular. O ensaio TRAVERSE (2023) mostrou que reposição de testosterona em homens com hipogonadismo e indicação adequada não aumenta risco cardiovascular maior, embora aumente ligeiramente fibrilação atrial e hematócrito. A decisão exige critério clínico, não automatismo.

- Medicamentos como estatinas (guiadas por CAC e ApoB), inibidores de SGLT2 (proteção cardiorrenal mesmo sem diabetes) e agonistas GLP-1 (mais que perda de peso) são ferramentas poderosas quando prescritos com precisão — não substitutos para estilo de vida.

- Genômica aplicada importa quando muda a conduta: MTHFR orienta tipo de folato e monitoramento de homocisteína; APOE4 identifica quem mais se beneficia de prevenção multidomínio intensiva; relógios epigenéticos quantificam a velocidade do envelhecimento biológico.

- Gestão metabólica não é receita pronta. É ciclo iterativo: testar, intervir, retestar, ajustar. Os biomarcadores são o painel. O piloto é o médico. O destino é o paciente.

---

> A gestão metabólica, por mais completa que seja, ainda opera na dimensão biológica. Mas há outra dimensão que influencia cada um dos marcadores que acabamos de discutir — uma dimensão que a medicina fragmentada ignora e que, quando não é tratada, sabota todos os outros pilares do método. É o que veremos a seguir.
