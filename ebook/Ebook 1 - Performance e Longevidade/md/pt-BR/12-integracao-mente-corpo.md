...
Durante dezoito meses, as consultas de Ana tinham mapeado o corpo com precisão. Registrei queixas somáticas — dor de cabeça tensional, rigidez no pescoço, sono fragmentado, queimação epigástrica intermitente —, mas nunca tinha feito o que finalmente fiz na sexta consulta: aplicar dois instrumentos curtos de triagem psicológica. O **PHQ-9**, com nove perguntas validadas para depressão, ela pontuou 14 — faixa moderada. O **GAD-7**, com sete perguntas para ansiedade generalizada, deu 16 — faixa severa. Esses dois números, que nenhum laboratório imprime, foram tão informativos quanto a PCR de 1,8.
...
**Treino cognitivo estruturado: o que funciona e o que é marketing.** O estudo **ACTIVE** (*Advanced Cognitive Training for Independent and Vital Elderly*) — cujos resultados de 10 anos foram publicados por Rebok e colaboradores no *Journal of the American Geriatrics Society* em 2014 — testou três modalidades em adultos de 65 ou mais: treino de raciocínio, treino de memória, e treino de velocidade de processamento. A análise específica de incidência de demência por Edwards e colaboradores, publicada em 2017 em *Alzheimer's & Dementia: Translational Research & Clinical Interventions*, mostrou o resultado mais forte para velocidade de processamento: apenas 10 a 14 sessões de 60 a 75 minutos, repetidas com reforços periódicos, reduziram o risco de demência em 29% ao longo de dez anos. Não é qualquer atividade — é treino específico, progressivo, repetido, focado em um domínio cognitivo. Sudoku todos os dias é melhor do que nada, mas não é treino estruturado. Plataformas como **BrainHQ** (Posit Science, baseada diretamente no ACTIVE) e **Lumosity** têm protocolos mais próximos do que foi testado, com qualidade variável. O *dual-task training* — combinar desafio cognitivo com atividade motora (caminhar enquanto conta regressivamente de 100 em saltos de 7, por exemplo) — tem sinal em idosos e é fácil de incorporar ao cotidiano.
...
- **MCI (comprometimento cognitivo leve)** tem conversão de 10–15%/ano para demência — janela de intervenção crítica. Ensaios **FINGER (2015)**, **MAPT** e **US POINTER (JAMA 2025)** convergem: intervenção multidomínio (exercício, dieta, treino cognitivo estruturado, controle vascular, acompanhamento) produz ganho cognitivo mensurável, com efeito maior em portadores de APOE4. **ACTIVE trial (JAMA 2014)** mostrou que treino de velocidade de processamento reduz risco de demência 29% em 10 anos — não é qualquer jogo; é treino específico, progressivo.
