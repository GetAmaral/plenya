...
**MTHFR e metilação.** Já tocamos no tema no Capítulo 7, na correção da homocisteína de André. O gene MTHFR codifica enzima essencial ao metabolismo do folato e ao ciclo da metionina, que gera o SAM-e (principal doador de grupos metila do corpo). Polimorfismos comuns (C677T, A1298C) reduzem a eficiência: homozigotos C677T (TT) podem ter atividade enzimática até 70% menor, o que se traduz em tendência a homocisteína elevada e dificuldade em sustentar a metilação. A intervenção clínica é concreta: folato já metilado (L-metilfolato/5-MTHF) em vez de ácido fólico sintético, B12 na forma ativa (metilcobalamina), e homocisteína como marcador funcional. André era caso clássico: vegetariano, homocisteína de 14, MTHFR que ninguém havia investigado.

**APOE4 e risco neurodegenerativo.** O gene APOE tem três variantes principais (ε2, ε3, ε4); cada pessoa carrega duas cópias. Portadores de uma cópia de ε4 têm risco aumentado para Alzheimer tardio; homozigotos (~2 a 3% da população) têm risco tão elevado que Fortea et al. (*Nature Medicine* 2024) propuseram classificar o APOE4 homozigoto como forma genética distinta de Alzheimer — praticamente todos os portadores desenvolvem marcadores biológicos aos 65 anos. APOE4 não é só gene de risco neurodegenerativo: afeta também o metabolismo lipídico sistêmico — portadores de ε4 têm LDL e ApoB mais elevados em média, menor benefício de dietas com gordura muito baixa, maior sensibilidade ao controle de carboidratos refinados e ao DHA, e frequentemente exigem alvo de ApoB mais agressivo. A mesma variante que empurra a neurodegeneração empurra, pelo mesmo caminho vascular, a aterosclerose.

A boa notícia é que intervenções de estilo de vida têm efeito maior em portadores de APOE4. Meta-análise de FINGER, MAPT e J-MINT (*Alzheimer's & Dementia* 2024) mostrou que intervenções multidomínio (exercício, dieta, treino cognitivo, controle vascular) produziram benefício cognitivo significativamente maior em ε4. Observacionais sugerem redução de risco de 30 a 45% com aderência a múltiplos pilares. APOE4 carrega a arma; o estilo de vida puxa — ou não puxa — o gatilho. Saber o status não é para ansiedade, é para priorizar.
