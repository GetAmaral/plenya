...
- Insulina de jejum: 13 µIU/mL. O laboratório considera normal até 25.
...
### Os Biomarcadores que Realmente Importam
...
O estudo PURE (Leong et al., *Lancet* 2015, 139.691 adultos em 17 países) demonstrou que cada 5 kg de redução na força de preensão se associa a 16% de aumento na mortalidade por todas as causas, 17% em mortalidade cardiovascular, 7% em infarto e 9% em AVC. Em análises ajustadas, o poder preditivo da preensão foi superior ao da pressão arterial sistólica — um marcador que se mede em toda consulta enquanto a preensão não se mede em quase nenhuma. Uma meta-análise dose-resposta de 2022 (48 estudos, 3,1 milhões de participantes) confirmou o padrão: relação praticamente linear na faixa de 26 a 50 kg.
...
O segundo dado, e talvez o mais subvalorizado da prática brasileira, é a **gordura visceral** (VAT — *visceral adipose tissue*). É a gordura ao redor de fígado, pâncreas, intestino e coração, fisiologicamente distinta da subcutânea — atua como órgão endócrino ativo, secreta citocinas inflamatórias e inunda o fígado de ácidos graxos pela veia porta. Nenhuma balança mede VAT, e a circunferência abdominal é uma aproximação grosseira. O DEXA quantifica em gramas, com erro pequeno. Como os valores absolutos variam por fabricante e etnia, o número a acompanhar é o **percentil do paciente no laudo** — o risco cardiometabólico se eleva consistentemente a partir do percentil 75. Na minha experiência, é o primeiro número a se mover quando um paciente começa a reverter disfunção metabólica — antes mesmo da insulina cair.
...
### Padrões e Clusters: Leia os Números em Conjunto
...
### Tendências: O Filme Importa Mais que a Fotografia
...
A esta altura do livro, você já sabe a pergunta. Pegue o resultado do seu último check-up e olhe não apenas o que veio escrito — mas o que não foi pedido. Quantos dos biomarcadores deste capítulo estão lá? Na maioria dos casos, a resposta é dois ou três. Os outros estão faltando. E são justamente os que contam a história mais importante — a história que antecede o diagnóstico em anos ou décadas.
...
- Faixas ótimas para longevidade são derivadas de estudos com centenários e dados longitudinais: HbA1c ≤ 5,4%, ApoB < 90 mg/dL, hs-CRP < 1,0 mg/L, insulina de jejum < 8 µIU/mL, homocisteína < 10 µmol/L.
