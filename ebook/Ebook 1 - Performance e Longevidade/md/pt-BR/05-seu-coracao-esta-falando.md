...
A magnitude da discordância entre os dois exames surpreende. No MESA, cerca de um terço dos eventos cardiovasculares ocorreram em participantes com CAC inicial zero; no *CAC Consortium*, 43% das mortes cardiovasculares aconteceram em pessoas com CAC zero. O zero protege muito. Não protege tudo.
...
**O que considerar antes de pedir.** A CCTA usa contraste iodado — contraindicada em insuficiência renal avançada, com precauções em alérgicos e em diabéticos em uso de metformina. Dose de radiação maior que a do CAC, custo superior, cobertura variável por planos de saúde. E há um risco menos óbvio: detecta lesões não-obstrutivas que podem gerar ansiedade e seguimento desnecessário se mal interpretadas. Pede leitura especializada — cardiologista integrando com o quadro clínico, não apenas laudo radiológico.
...
A primeira é o **sal**. O brasileiro adulto consome em média 12 g de sal por dia — quase o dobro do teto da OMS (5 g). E essa quantidade não vem do saleiro: vem de pão, embutidos, queijos, caldos em tabletes e ultraprocessados em geral. Reduzir o sal para perto de 5 g por dia costuma baixar a sistólica em 5 a 8 mmHg — efeito comparável a um anti-hipertensivo em dose baixa. É a base de onde se começa.
