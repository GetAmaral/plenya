...
**Público-alvo:** adultos 35–60 anos preocupados com envelhecimento saudável, executivos, profissionais liberais.
...
## Personagens-âncora (casos clínicos ao longo do livro)
...
Todas as figuras estão nas pastas de origem (`../Cap0X Fig0Y.PNG`). A pasta `md/` mantém os arquivos Markdown com referências relativas.

Briefings de imagens: `../Briefing Figuras Capitulo 0X.pdf`
Briefing geral: `../Briefing Ebook 1 AGIR Corrigido.pdf`
Estrutura e referências: `../Ebook1 O Protocolo da Longevidade Estrutura e Referencias.pdf`
