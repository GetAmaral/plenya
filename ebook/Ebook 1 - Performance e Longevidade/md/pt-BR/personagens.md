# Personagens-âncora — Bíblia de Referência

> Documento de referência interno para consistência narrativa, continuidade de valores clínicos e revisão editorial. Não é parte do livro.
...
- PA: 128/82 ("um pouquinho acima, mas nada preocupante" — fala do médico ficcional; tecnicamente é HAS estágio 1 pela ACC/AHA 2017)
- ECG: sem alterações
- Orientação: "voltar no ano seguinte"

### Evento índice (Cap 1)
- **Quando:** terça-feira, 7h42 da manhã
- **Onde:** estacionamento do escritório
- **O que:** infarto agudo do miocárdio — placa instável rompeu em coronária
- **Resgate:** colega o encontrou → SAMU em 11 minutos → stent
- **Desfecho:** sobreviveu

### Painel ampliado pós-infarto (primeira consulta com autor — 3 meses depois)
| Marcador | Ricardo | "Normal" lab | Ótimo |
|---|---|---|---|
| Insulina jejum | **14 µIU/mL** | < 25 | < 8 |
...
- Alimentação "bem para os padrões brasileiros"
- Sem queixas, sem doenças
- Sono ~6h/noite, estresse "normal para quem trabalha e tem dois filhos"
...
| | HbA1c | 5,5% | Normal (limítrofe) |
| | Colesterol total | 201 mg/dL | Normal |
| | LDL | 119 mg/dL | Normal |
| **Ampliado** | Insulina jejum | **13 µIU/mL** | Acima do ótimo (<8) |
| | HOMA-IR | **3,0** | Resistência insulínica |
| | ApoB | **108 mg/dL** | Acima do ótimo (<90) |
| | hs-CRP | **1,9 mg/L** | Inflamação crônica |
| | Homocisteína | **12,4 µmol/L** | Acima do ótimo (<10) |
| | Vitamina D | **22 ng/mL** | Insuficiente |
| | Triglicerídeos | 180 mg/dL | — |
| | HDL | 46 mg/dL | — |
| | TG/HDL | **3,9** | Resistência insulínica |
| | GGT | 34 U/L | Acima do ótimo (<30) |
| **Imagem** | US abdominal | Esteatose grau I | MASLD |
| **Antropometria** | IMC | 23 | "Normal" |
| | Circunferência abdominal | "No limite" | — |
| | Pressão | 118/76 | Ótima |

**Estágio metabólico:** transição Fase 1 → Fase 2 (resistência insulínica compensada evoluindo para disfunção manifesta)
...
## 3. André — "O triatleta com inflamação oculta"

**O caso contra-intuitivo:** fazer tudo aparentemente certo não basta se o treino está mal estruturado e os déficits nutricionais nunca foram investigados.

### Demografia
- 45 anos
- Executivo de multinacional
- Triatleta amador
- Vegetariano há 6 anos
- Meditação diária
- Tinha relógio com HRV em tempo real
- "Parecia ter 40"

### Porta de entrada
- Aspiracional: veio "otimizar tudo"
- Trouxe dossiê de exames próprios

### Baseline
| Marcador | Valor | Leitura |
|---|---|---|
| PCR | **2,1 mg/L** | Inflamação crônica |
| Homocisteína | **14 µmol/L** | Acima do ótimo |
| Insulina jejum | 8,5 µIU/mL | "Normal" mas suspeito |
| HOMA-IR | 1,9 | "Normal" |
| Vit B12 / folato | (não explícito; vegetarianismo + Hcy alta sugere déficit) | — |
| Idade biológica estimada | **>55 anos** (vs. 45 cronológica) | Aceleração epigenética |

### TOTG com curva insulinêmica (Cap 6)
| Tempo | Glicose (mg/dL) | Insulina (µIU/mL) |
|---|---|---|
| 0 (jejum) | 92 | 8,5 |
| 30 min | 148 | 78 |
| 60 min | **162** | **124** |
...
| PCR | 2,1 | **0,7** |
| Homocisteína | 14 | **9** |
| Composição corporal | — | Menos gordura visceral, mais massa magra |
...
## 4. Marcos — "A Regra dos Dois em ação"

**O paciente que tomava estatina e achou que estava resolvido.** Caso-tipo do CAC que redefine a categoria de risco e da ação concentrada.
...
- LDL: 148 → 78 mg/dL
- Colesterol total: 240 → 168 mg/dL
- Cardiologista "satisfeito"

### Reação inicial ao pedido de CAC
*"Mas meu colesterol está controlado, doutor. A estatina resolveu."*

### Baseline ampliado (após CAC 412)
| Marcador | Valor | Leitura |
|---|---|---|
| **CAC Agatston** | **412** | Prevenção secundária funcional |
| Idade arterial | **≈ 80 anos** (gap +23, percentil >90) | — |
| ApoB | **82 mg/dL** | Sob estatina, ainda acima do alvo <60 |
| Insulina jejum | **11 µIU/mL** | Resistência insulínica |
| hs-CRP | **1,6 mg/L** | Inflamação |
| Vitamina D | **28 ng/mL** | Insuficiente |
| Sono | ~5h30 com 2 despertares/noite | Não consolidado |

### Contexto comportamental
- Alimentação dispersa (pão de queijo no café → nenhuma proteína real até almoço → 12h entre jantar e primeira proteína)
- Treino sem estrutura
- Jantar rotineiramente às 22h

### Reação ao CAC de 412
...
## 5. Paulo — "Quatro tempos, uma apneia oculta"

**O caso mais técnico do livro.** Mostra a interdependência dos quatro pilares — um pilar negligenciado (R) derruba o que foi construído nos outros.

### Demografia
- 48 anos na primeira consulta → 50 anos no fim do arco (24 meses)
- Executivo de empresa de tecnologia
- Casado há 20 anos
- Dois filhos
...
| Testosterona livre | **4,8 pg/mL** | Valor típico de homens de 70 anos |
| Vitamina D | **24 ng/mL** | Insuficiente |
| hs-CRP | **1,7 mg/L** | Inflamação |
| Sono | ~6h com microdespertares frequentes | Não consolidado |
| Ronco | Presente "há anos" (reclamação da esposa) | **Não investigado** |
| Sonolência diurna | Ausente | — |

### Reação ao painel hormonal
*"Mas se não estou com sintoma, importa?"*

### Intervenções Fase 1 (A + G, **sem reposição hormonal**)
1. Reestruturação do sono (dormir mais cedo, reduzir telas)
2. Otimização de vitamina D
3. Ajuste no treino de força com movimentos compostos e carga progressiva

### Trajetória de 4 tempos (24 meses)

#### T + 4 meses
- Testosterona total: 310 → **420**
...
| Testosterona livre | **11,2 pg/mL** |
| DHEA-S | subiu |
| Vitamina D | **58 ng/mL** |
| hs-CRP | 1,7 → **0,9** |
| Composição corporal | +2 kg massa magra |
| Idade epigenética | **desaceleração de 2 anos** |
...
| Marcador | T+6m | T+18m |
|---|---|---|
| Testosterona total | 485 | **410** |
| Testosterona livre | 11,2 | **8,4** |
| hs-CRP | 0,9 | **1,3** |
| HbA1c | 5,2 | **5,5** |
...
|---|---|---|
| Testosterona total | 410 | **540** (acima do pico anterior de 485) |
| Testosterona livre | 8,4 | **12,1** |
| hs-CRP | 1,3 | **0,6** |
| HbA1c | 5,5 | **5,1** |
| MAPA 24h | *non-dipper* | **dipper adequado** |
| Idade epigenética | — | **−1 ano adicional** |
| IAH (polissonografia controle) | 22 | **2** |
| Sono N3 | <5% | **17%** |

### Fala após 4 semanas de CPAP
...
### Porta de entrada
- Decidida a "otimizar tudo o que pudesse ser otimizado"
...
| Insulina jejum | 11 | **7** |
| ApoB | 102 | **78** |
| Homocisteína | 12 | **8** (com B12 + folato metilado) |

Hábitos instalados:
- Treino: 3x força + 2x zona 2
- Sono: deitar às 22h30
- Alimentação: eliminou ultraprocessados

### Os dois números que não desceram
| Marcador | Inicial | Após 18m |
|---|---|---|
| **hs-CRP** | 2,1 | Oscila **1,6 – 1,9** (persistente) |
| **Cortisol matinal** | 21 µg/dL | **22** (persistente) |
...
- Sono fragmentado há anos
- Acordava várias vezes pensando em problemas não resolvidos
...
| André | 2,1 | 0,7 |
| Marcos | 1,6 | 0,6 |
| Paulo | 1,7 → 0,9 → 1,3 (regressão) | 0,6 |
| Ana | 2,1 → 1,6–1,9 (persistente) | 0,7 |
