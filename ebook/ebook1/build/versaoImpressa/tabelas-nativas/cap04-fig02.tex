...
\vspace{0.25em}
% \captionof em vez de número fixo: esta tabela não é float, então não incrementava
% o contador, e o "4.2" era escrito à mão — drift garantido a cada figura nova. O
% \captionof numera pelo contador e aplica o mesmo estilo das outras legendas.
% O título saiu da legenda: ele já está no alto da própria tabela.
\captionof{figure}{M = homens; F = mulheres. Faixas de referência podem variar
conforme método/laboratório. Interpretar com painel clínico completo (ESC/EAS,
ACC/AHA, ABRAN).}
\endgroup
