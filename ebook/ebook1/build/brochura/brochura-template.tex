% =====================================================================
%  ANTES — Print template for BROCHURA COM ORELHAS (gráfica nacional)
%  Engine: XeLaTeX
%  Body  : TeX Gyre Pagella 11/14
%  Trim  : 16 × 23 cm (160 × 230 mm) + 2,5 mm de sangria → página 165 × 235 mm
%  Color : miolo P&B (figuras vetoriais B&W); a cor vive só na capa
...
% ink é neutro (#1a1a1a = R=G=B), então sai como cinza de uma chapa: é o cabeço
% de toda página e não tem por que virar preto de quatro cores na conversão. As
% duas cores cromáticas (petrol e gold) seguem em RGB até a gráfica dizer com que
% perfil converte — a mesma regra da papelaria, CMYK só depois de aprovação.
\definecolor{ink}{gray}{0.102}
...
\hypersetup{
  ...
  pdfsubject={Medicina preventiva e longevidade — edição brochura com orelhas},
