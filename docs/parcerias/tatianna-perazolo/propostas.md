...
> cadastrada como "ambulatorial restrita a consultas".
> **Decisões já tomadas na conversa:**
> - A ginecologista que atendia no endereço saiu: a linha de menopausa é da Plenya por inteiro,
>   incluindo terapia hormonal.
> - A parceria inclui montar um **centro de infusão**: além do cardápio oral, há cardápio de
>   injetáveis. Ele herda as decisões molécula a molécula de
>   [portfolio-injetaveis.md](../../clinica/portfolio-injetaveis.md) (§15 = protocolos ofertáveis)
>   e o plano regulatório de [centro-infusao-e-exames.md](../../clinica/centro-infusao-e-exames.md).
> - Carro-chefe proposto (aguarda confirmação): Jornada do Procedimento.

---

## 1. A tese

A dermatologia estética trata a pele por fora, num tempo curto de procedimento. A Plenya trata o
terreno em que esse procedimento cicatriza, remodela e dura: ferro, proteína, glicemia, hormônios,
sono, inflamação. A proposta para a Dra. Tatianna tem duas moedas:

1. **O resultado dela dura mais e tem menos intercorrência**, porque a paciente chega ao
   procedimento sem deficiência e sai para uma recuperação conduzida.
2. **A paciente dela ganha um motivo clínico para voltar**, porque passa a ter um
   acompanhamento contínuo, e não só uma agenda de procedimentos.
...
|---|---|---|
| Vias | tópico, intradérmico, procedimentos (laser, peeling, toxina, preenchedor, bioestimulador, fios, cirurgia dermatológica, MMP/PRP capilar) | oral, IM, SC, IV (centro de infusão) |
| Diagnóstico | dermatológico, tricoscopia, dermatoscopia | metabólico, hormonal, nutricional, renal, Escore Plenya (800+ itens) |
| Terapias sistêmicas | as da dermatologia (isotretinoína, espironolactona na acne, antivirais etc.) | THM, GLP-1, reposição de deficiências, sensibilizadores de insulina, nutricosméticos com lastro |
| Onde se encontram | protocolo co-assinado por linha de cuidado + prontuário compartilhado (com consentimento LGPD) + reunião mensal de casos | |
...
- **Injetáveis estéticos sem via legal no Brasil ficam fora:** PDRN e exossomos injetáveis
  (ANVISA só regulariza como cosmético tópico; CRM-PR Parecer 2.936/2025), glutationa para
...
```
            ┌──────────────────────────────────────────────┐
            │  BASE COMUM: Avaliação Plenya na clínica     │
            │  consulta + Escore Plenya + painel de sangue │
            │  + bioimpedância + preensão palmar           │
            └──────────────────────┬───────────────────────┘
      ┌──────────┬──────────┬──────┴─────┬──────────┬──────────┬──────────┐
     L1         L2         L3          L4         L5         L6         L7
  Jornada   Menopausa   Cabelo     GLP-1 com  Pele meta- Pele e     Homem
  do Proce-                        pele e     bólica e   longevi-
  dimento                          massa magra inflamat. dade
      └──────────┴──────────┴──────┬─────┴──────────┴──────────┴──────────┘
            ┌──────────────────────┴───────────────────────┐
            │  CAMADA TRANSVERSAL: centro de infusão       │
            │  + cardápio oral (sempre por indicação)      │
            └──────────────────────┬───────────────────────┘
            ┌──────────────────────┴───────────────────────┐
            │  CONTINUIDADE: Continuum Médico              │
            │  (online ou presencial em Londrina)          │
            └──────────────────────────────────────────────┘
```

O check-up (ideia 1 original) vira a **base comum**: é por onde toda linha começa, em vez de ser
vendido isolado.
...
### L1 · Jornada do Procedimento (antes, durante, depois): carro-chefe proposto

**Para quem:** paciente com procedimento de maior porte agendado: laser ablativo ou fracionado,
peeling médio ou profundo, bioestimulador de colágeno, fios, cirurgia dermatológica.
Procedimentos pequenos (toxina, preenchimento pontual) não precisam da jornada completa.

**Por que funciona:** a literatura de cirurgia plástica tem protocolo estruturado de triagem e
reposição perioperatória; nutrição adequada se associa a menos complicação e melhor cicatrização;
tabagismo multiplica complicação em procedimentos faciais de 1,8 a 12 vezes. Honestidade: a
evidência é extrapolada de cirurgia e cicatrização, não há ensaio para cada procedimento
dermatológico. O discurso é "preparar o terreno", nunca "garantir resultado".

**Cronograma (2026-09-11: padrão de 3 semanas; expresso 10 a 14 dias para procedimentos médios sem deficiência; estendido 4 a 6 semanas para tabagismo, diabetes descompensado, anemia ou desnutrição).** O que realmente pede prazo: proteína 7 a 14 dias; ferro EV em dose única recompõe o estoque e a Hb sobe nas 2 primeiras semanas; coleta na clínica com resultado em dias; só o tabagismo exige 4 semanas ou mais.

| Quando | Plenya | Dermatologia |
|---|---|---|
| **−3 semanas (uma visita)** | Avaliação Plenya. Triagem: hemograma, ferritina + saturação de transferrina, albumina, 25-OH-D, B12, zinco, glicemia/HbA1c, **insulina de jejum (HOMA-IR; curva insulinêmica se suspeita)**, **homocisteína (meta abaixo de 10)**, **PCR ultrassensível**, TSH, função renal. Bioimpedância ("falso magro", gordura visceral). Rastreio de tabagismo, sono, uso de suplementos, **uso de isotretinoína/acitretina** | indica o procedimento e a data; **a recepção dela aplica o questionário de triagem nutricional de 1 minuto** (bundle de Vitagliano 2023) e encaminha quem pontua |
| **−3 a −1 semana** | Corrige o que faltou, pelo algoritmo de ferro da casa (hemoglobina abaixo de 13 investiga; ferritina abaixo de 30 repõe, **EV** quando o tempo é curto, porque recarrega em semanas e o oral leva meses; ferritina 30–100 com saturação abaixo de 20% ou PCR acima de 5 é inflamação, trata a inflamação antes; acima de 100 com saturação baixa e PCR alta, inflamação crônica). Magnésio oral. Vitamina A só se deficiente e **nunca em quem usa retinoide sistêmico**. Evitar vitamina E em dose alta (atrasa cicatrização). **B12 IM**, vitamina D oral, zinco oral só se deficiente. Proteína (whey 20–30 g/dia de 7 a 14 dias antes no risco intermediário; 1,2–1,5 g/kg/dia no alto risco). Vitamina C oral. **Cessação do tabagismo pelo menos 4 semanas antes** (reduz complicação de ferida em cerca de 30% nas meta-análises cirúrgicas; cada semana a mais aumenta o efeito). Controle glicêmico. Sono | combina com a Plenya a suspensão do que aumenta sangramento/equimose antes de injetáveis (ômega-3 em dose alta, vitamina E, ginkgo, AINE) 🔲 protocolo dela |
...
- THM na janela de oportunidade (menos de 10 anos de menopausa ou menos de 60 anos), por
  climatério sintomático: **estradiol transdérmico registrado** (menos risco trombótico que o
  oral) + **progesterona micronizada** se útero presente (proteção endometrial obrigatória; à
  noite ainda ajuda o sono). Sem implantes, sem "bioidêntico manipulado superior" (vedado).
- Síndrome geniturinária: estrogênio vaginal em dose baixa, prasterona vaginal (magistral,
  C5) ou gel vaginal de ocitocina (não hormonal, para quem não pode estrogênio).
...
mamografia, avaliação endometrial quando indicada.** 🔲 Colpocitologia e exame ginecológico
exigem ginecologista: definir referência externa.

### L3 · Cabelo: queda capilar feminina

**Para quem:** eflúvio telógeno, alopecia de padrão feminino, quadros mistos. Queda pós-parto,
pós-dieta, pós-GLP-1, pós-COVID.

**Por que funciona:** ferritina e vitamina D baixas aparecem de forma consistente nessas
pacientes; o eflúvio crônico tem causas metabólicas comuns e corrigíveis.

**Camadas (do portfólio, §15 A5):**
- **Camada 0, diagnóstico:** dela, tricoscopia e classificação (eflúvio × padrão × misto). Nossa,
  anamnese dirigida (gatilho 3 a 6 meses antes, eixo hormonal/menstrual, medicações, dieta) e
  exames: hemograma, **ferritina com meta acima de 70 ng/mL**, saturação de transferrina, 25-OH-D,
  B12, zinco, TSH/T4 livre, androgênios se indicado.
...
### L4 · Emagrecimento com GLP-1 preservando pele, cabelo e massa magra

**Para quem:** quem vai iniciar ou já usa semaglutida/tirzepatida, ou quer emagrecer com
acompanhamento.

**Por que funciona:** o emagrecimento rápido cobra da pele (a "face do GLP-1": perda de volume e
flacidez), do cabelo e do músculo. No subestudo DEXA do STEP 1, a massa magra caiu 9,7% contra
19,3% da massa gorda, perto de 40% do peso perdido. A queda de cabelo associada a GLP-1 (sobretudo
eflúvio telógeno) aparece de 3 a 6 meses após o início, é mais comum em mulheres, parece
dose-dependente e costuma resolver em 6 a 12 meses com a estabilização do peso.

**Plenya (protocolo D2 do portfólio):** GLP-1 **sempre em programa**: titulação no ritmo que a
pele acompanha, proteína 1,2–1,6 g/kg, treino de força, bioimpedância e preensão seriadas,
ferritina/zinco/vitamina D antes e durante, vigilância do cabelo. Semaglutida pela caneta
...
**Por que é forte comercialmente:** é a demanda mais aquecida do mercado, e nenhuma das duas
entrega o resultado completo sozinha.

### L5 · Pele metabólica e inflamatória

**Acne adulta, SOP e hiperandrogenismo:** a resistência à insulina é motor; metformina tem 11 ECRs
e 9 coortes em acne associada à SOP, com melhora na maioria. Plenya conduz o metabolismo
(inositol mio:D-chiro 40:1, metformina, dieta de baixa carga glicêmica, composição corporal); a
dermatologia conduz a pele.

**Psoríase, hidradenite, rosácea:** psoríase moderada a grave se associa a síndrome metabólica e
risco cardiovascular; a Plenya entra no manejo cardiometabólico de fundo, sem tocar no tratamento
dermatológico.
...
|---|---|
| acantose nigricans, acrocórdons múltiplos | resistência à insulina, pré-diabetes |
| xantelasma | perfil lipídico, ApoB, Lp(a) |
| queda difusa, unhas frágeis | ferro, tireoide, vitamina D, B12, zinco |
| acne tardia, hirsutismo | SOP, androgênios, resistência à insulina |
| **prurido crônico sem lesão** | função renal, hepática, tireoide, ferro (**ângulo nefrológico**) |
| cicatrização lenta, infecções de repetição | glicemia, nutrição, deficiências |
| pele seca com intolerância ao frio | tireoide |
| psoríase moderada/grave | risco cardiometabólico |

**Fotodano:** **nicotinamida oral 500 mg 2×/dia** reduziu em 23% novos cânceres de pele não
melanoma em 12 meses no ECR de fase 3 ONTRAC (NEJM 2015), e as ceratoses actínicas em 11 a 20%,
em pacientes com pelo menos 2 cânceres prévios. É o encaixe mais limpo entre as duas áreas, para
a população de alto risco dela. Polypodium leucotomos oral como adjuvante de fotoproteção
(erupção polimorfa à luz, melasma), nunca substituto de protetor.

### L7 · Homem

Alopecia androgenética (diagnóstico e terapia dela; metabolismo nosso), GLP-1 em programa,
testosterona **só em hipogonadismo diagnosticado** (nunca estética), check-up. Encaixa no público
da marca (35 a 55 anos, misto).

### Transversal · Encontros educativos

Encontros periódicos para as pacientes dela (ex.: "pele e menopausa", "GLP-1 sem perder o
rosto"), dentro da Res. 2.336: educativos, sem promessa, sem preço.

---

## 6. Cardápio de injetáveis da parceria

Recorte do [portfólio §15](../../clinica/portfolio-injetaveis.md) filtrado para o público da
clínica. **Todo item exige consulta, exame e indicação em prontuário.**

### Núcleo: reposição de deficiência documentada
| Protocolo | Via | Indicação | Linhas |
|---|---|---|---|
| **Ferro EV** (carboximaltose ou derisomaltose) | IV | deficiência de ferro documentada, falha do oral, recarga pré-procedimento | L1, L2, L3, L4 |
| **B12** (hidroxocobalamina) | IM | deficiência, má absorção, vegetariana, metformina crônica | L1, L3, L4 |
| **Vitamina D** | oral (IM só em má absorção) | deficiência | todas |
| **Tiamina / complexo B** | IV ou IM | deficiência, pós-bariátrica | L4 |
| **Magnésio** | IV com gate renal | hipomagnesemia; enxaqueca aguda | transversal |

### Linhas específicas
| Protocolo | Via | Indicação | Linhas |
|---|---|---|---|
| **GLP-1** (semaglutida / tirzepatida) | SC | obesidade/sobrepeso com comorbidade, sempre em programa | L4, L5 |
| **Vitamina C funcional** (até 15 g) | IV | fase de reparo pós-procedimento; zóster (adjuvante ao antiviral); QoL pontual. Gates: G6PD, função renal, insumo sem metabissulfito | L1, zóster |
| **Testosterona** | IM/SC | só hipogonadismo diagnosticado | L7 |

### Bem-estar, com disclaimer de experiência (não cura)
| Protocolo | Via | Nota |
|---|---|---|
...
- **"Soro da beleza", detox, antioxidante master, NAD+ IV**: sem desfecho; alguns combos
  aumentam toxicidade.
- **PDRN e exossomos injetáveis**: sem via legal no Brasil (só cosmético tópico).
- **GHK-Cu injetável, BPC-157 e demais peptídeos experimentais**: sem registro, mercado cinza.
- **Hormônio com fim estético** (testosterona, DHEA, GH para "anti-aging"): vedado pelo CFM.

A Dra. Tatianna expõe o próprio CRM ao se associar a um centro de infusão. Mostrar a lista do que
recusamos é o que prova que o dela fica protegido.

## 7. Cardápio oral (nutricosméticos e fármacos com lastro)

Nomes genéricos; marca e fornecedor ficam para a prescrição.
...
- Projeto aprovado na DAPES/SESA-PR **antes** da reforma; classificação de risco sanitário;
  licença sanitária da VISA Londrina (infusão não é baixo risco); alvará; CNES; AVCB; PGRSS.
- **Enfermeira responsável técnica (COREN-PR)** + técnica de enfermagem: é a primeira contratação
  que o centro exige.
- Rede de frio 2–8 °C monitorada; carrinho de emergência checado por turno + DEA; observação de
  pelo menos 30 min após ferro e tiamina IV.
- **Cenário A:** só aplicação de produto pronto ou manipulado nominal de farmácia licenciada para
  estéreis; nenhuma manipulação no local.
- Área de referência: cerca de 6 m² por poltrona de infusão, posto de enfermagem, sala de preparo.
- Ambiente de medicina premium serena, nunca bar de vitamina nem hospital.

### Exames no local (Fase 1 do portfólio de exames)
Posto de coleta (só pré-analítica, lab de apoio pode equipar) + bioimpedância + preensão palmar.
Tudo sem radiação, operador leve. Densitometria e imagem por parceria.

### Fluxo da paciente
Recepção dela identifica gatilho ou interesse → consulta Plenya na clínica → coleta no local →
devolutiva com Escore → protocolo co-assinado → infusões e orais → reavaliação conjunta →
...
## 9. Pendências (decidir uma de cada vez)

1. Carro-chefe da reunião (proposta: L1 Jornada do Procedimento).
2. Formato jurídico do centro de infusão (proposta: opção 1).
3. Quais linhas entram no lançamento e quais ficam para uma segunda onda.
4. Espaço físico disponível na clínica dela (quantas salas, poltronas).
...
- Nutrição e cicatrização em estética (JPRAS Open 2024): https://pubmed.ncbi.nlm.nih.gov/38370002/
- Tabagismo e cicatrização em procedimentos faciais: https://pmc.ncbi.nlm.nih.gov/articles/PMC12968644/
- Menopausa e pele (Climacteric 2022): https://www.tandfonline.com/doi/full/10.1080/13697137.2022.2050206
- THM e rejuvenescimento da pele, meta-análise: https://pubmed.ncbi.nlm.nih.gov/38230593/
- THM e pele, revisão 2025 (J Cosmet Dermatol): https://onlinelibrary.wiley.com/doi/10.1111/jocd.70393
- Colágeno oral, meta-análise positiva (2023): https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10180699/
- Colágeno oral, meta-análise por qualidade/financiamento (Myung & Park, Am J Med 2025): https://www.amjmed.com/article/S0002-9343(25)00283-9/abstract
- Cessação do tabagismo e complicações (Mills, Am J Med 2011): https://pubmed.ncbi.nlm.nih.gov/21295194/
- Ferritina e vitamina D na queda feminina: https://pubmed.ncbi.nlm.nih.gov/23428658/
- Metformina na acne da SOP: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9511677/
- STEP 1, composição corporal: https://academic.oup.com/jes/article/5/Supplement_1/A16/6240360
- GLP-1 e queda de cabelo, revisão sistemática: https://pmc.ncbi.nlm.nih.gov/articles/PMC13100445/
- "Ozempic face", revisão sistemática: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12232544/
- ONTRAC, nicotinamida (NEJM 2015): https://www.nejm.org/doi/full/10.1056/NEJMoa1506197
- Polypodium leucotomos, revisão: https://pubmed.ncbi.nlm.nih.gov/24688621/
- PDRN injetável vedado, CRM-PR: https://www.crmpr.org.br/Parecer-do-CRMPR-reforca-vedacao-ao-uso-injetavel-do-PDRN-em-tratamentos-esteticos-11-60402.shtml
