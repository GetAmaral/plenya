...
| `00022_score_versions.sql` | migration goose | `cmd/migrate up` (cria `score_versions` + `score_version_items`; **seed** de 2 versions — Triagem 36 itens, Light 83 itens — e 119 vínculos) |
