...
-- (4) ASEX /25→/30 → (5) Tratamentos composição L5. Todos idempotentes.
--
-- Os deltas de ESCORE (sufixos coerentes, Hipertensão arterial pessoal, Artrite
-- filha de auto-imunes, Psoríase/Vitiligo/Hashimoto) foram CONVERTIDOS para a
-- migration goose 00055_score_sufixos_has_autoimunes.sql (roda no deploy do api),
-- e por isso saíram deste bundle. Ver nota no fim do arquivo.
--
-- Aplicar:
...
--   escore-tratamentos-composicao-level5.sql
-- ============================================================================

-- ████ PARTE 1/5 — RENAME TEMPLATES ██████████████████████████████████████████
-- ============================================================================
...
-- ████ PARTE 3/5 — RECOMPOSE (moves item-a-item) ████████████████████████████
-- ============================================================================
...
-- ████ PARTE 5/5 — ESCORE: Tratamentos composição, level 5 ███████████████████
-- ============================================================================
...
-- ============================================================================
-- NOTA: os deltas de ESCORE (sufixos coerentes, Hipertensão arterial pessoal,
-- Artrite filha de auto-imunes, Psoríase/Vitiligo/Hashimoto) foram CONVERTIDOS
-- para a migration goose `apps/api/database/migrations/00055_score_sufixos_has_autoimunes.sql`,
-- que roda no deploy do api (RUN_MIGRATIONS=true). Não estão mais neste bundle.
-- ============================================================================
