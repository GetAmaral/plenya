...
INSERT INTO scientific_articles (id, title, authors, journal, publish_date, article_type, pmid, doi, summary, created_at, updated_at)
VALUES
(
    gen_random_uuid(),
...
GROUP BY si.id, si.label, si.category, si.clinical_relevance, si.patient_explanation, si.conduct, si.last_updated;
...
INNER JOIN score_item_articles sia ON sa.id = sia.article_id
WHERE sia.score_item_id = '9c5ef523-046b-4647-abd4-719937d54eb6'
