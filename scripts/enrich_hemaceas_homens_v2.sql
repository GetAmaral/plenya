...
INSERT INTO articles (
    ...
    original_link, article_type, specialty, created_at, updated_at
)
VALUES
    (
        gen_random_uuid(),
    ...
    (
        gen_random_uuid(),
        'Polycythemia Vera - Clinical Features and Diagnosis',
        'StatPearls Authors',
        'StatPearls Publishing',
        '2024-01-01',
        'en',
    ...
    (
        gen_random_uuid(),
        'Red Cell Indices - Clinical Significance',
        'Clinical Methods Authors',
        'NCBI Bookshelf',
        '2024-01-01',
        'en',
...
SET title = EXCLUDED.title,
    updated_at = NOW()
WHERE articles.original_link IS NOT NULL;
