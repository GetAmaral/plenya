...
SELECT
    ...
    NOW()
FROM articles
WHERE doi = '10.1177/10775587221113228'
ON CONFLICT (score_item_id, article_id) DO NOTHING;

-- Artigo 2: Goal planning in mental health
INSERT INTO articles (
    id,
    title,
    authors,
...
SELECT
    ...
    NOW()
FROM articles
WHERE doi = '10.3389/fpsyt.2022.1057915'
ON CONFLICT (score_item_id, article_id) DO NOTHING;
...
SELECT
    '=== CAMPOS ATUALIZADOS ===' as status,
    name,
    points,
    last_review::date,
    LENGTH(clinical_relevance) as cr_chars,
    LENGTH(patient_explanation) as pe_chars,
