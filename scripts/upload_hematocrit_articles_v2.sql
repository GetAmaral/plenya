...
-- Usando apenas article_type permitidos pelo constraint
...
-- 2. NEJM - Polycythemia Vera Treatment (Randomized Trial)
INSERT INTO articles (
  id, title, authors, journal, publish_date, language,
  original_link, article_type, specialty, doi, pm_id,
  abstract
)
VALUES (
  gen_random_uuid(),
...
-- 5. Haematologica - Thrombotic Risk (Systematic Review)
INSERT INTO articles (
  id, title, authors, journal, publish_date, language,
...
GROUP BY a.id, a.title, a.journal, a.article_type, a.original_link
ORDER BY a.title;
