#!/usr/bin/env bash
# Generate an INFOGRAPHIC-style figure in US ENGLISH for the /en blog.
# Same visual style as gen-figure.sh, but the language constraint at the
# end of the style suffix is switched to English so OpenAI does not
# default to Portuguese rendering.
#
# Usage: gen-figure-en.sh <slug> <name> "<prompt>"
# Output: /images/blog/<slug>/<name>.webp (1024x1024)
#
# Convention for EN figures: pass <name> as "figura-1-en" (or similar)
# so the file lands as /images/blog/<pt-slug>/figura-1-en.webp,
# sibling to the existing PT figura-1.webp.
set -euo pipefail
