...
RETURNING id, pm_id, title;

-- Link Article 1 to Score Item
INSERT INTO article_score_items (article_id, score_item_id)
SELECT a.id, 'fe938255-6b7a-4fbd-ac8f-8f3ba0c2d291'
FROM articles a
WHERE a.pm_id = '40427034'
ON CONFLICT (article_id, score_item_id) DO NOTHING;

-- Article 2: SHBG as Independent Predictor for Insulin Resistance in T2DM Men (2023)
INSERT INTO articles (
    id,
    pm_id,
    title,
...
GROUP BY si.id, si.name, si.category, si.subcategory, si.clinical_relevance, si.patient_explanation, si.conduct, si.last_review;
...
-- Clinical Relevance: 1,997 characters
-- Patient Explanation: 1,447 characters
-- Conduct: 2,497 characters
-- Articles: 4 peer-reviewed (2023-2025)
-- Focus: SHBG physiology, metabolic syndrome, insulin resistance, aging, testosterone bioavailability
-- ========================================
