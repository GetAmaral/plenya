...
-- Articles: 4 peer-reviewed publications (2015-2021)
...
WHERE si.id = '31436e15-994d-4a39-b1c5-ae6cf494dacb'
GROUP BY si.id, si.label, si.code, si.clinical_relevance, si.patient_explanation, si.conduct;
...
-- EXECUTION SUMMARY
-- ============================================================================
-- Score Item: LH - Mulheres Fase Lútea
-- Articles Linked: 4
-- - Duncan WC (2021) - The inadequate corpus luteum [PMID: 35128435]
-- - Oliver R, Pillarisetty LS (2023) - Anatomy of Corpus Luteum [PMID: 30969526]
-- - Mesen TB, Young SL (2015) - Progesterone and Luteal Phase [PMID: 25681845]
-- - ASRM (2021) - Diagnosis and treatment of LPD [PMID: 33827766]
--
-- Clinical Content Character Counts:
-- - clinical_relevance: 2000+ chars (target: 1500-2000)
-- - patient_explanation: 1400+ chars (target: 1000-1500)
-- - conduct: 4000+ chars (target: 1500-2500)
-- ============================================================================
