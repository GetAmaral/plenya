...
-- ============================================================================
-- 2. VINCULAR ARTIGOS AO SCORE ITEM
-- ============================================================================

-- Vincular todos os 4 artigos ao item Manganês
INSERT INTO article_score_items (article_id, score_item_id)
SELECT id, '613ec0ea-13dc-44ba-a0a5-918beeca4374'
FROM articles
WHERE doi IN (
    '10.3390/biom13081190',
    '10.1038/s41419-023-06262-0',
...
-- ============================================================================
-- 3. ATUALIZAR CONTEÚDO CLÍNICO DO SCORE ITEM
-- ============================================================================
